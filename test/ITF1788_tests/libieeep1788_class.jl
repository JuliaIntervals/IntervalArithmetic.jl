...
@testset "minimal_text_to_decorated_interval_test" begin
    ...
    @test_throws ArgumentError var"@decorated"(LineNumberNode(1), @__MODULE__, "[  -1.0  , 1.0]_fooo")
    ...
    @test_throws ArgumentError var"@decorated"(LineNumberNode(1), @__MODULE__, "[1.0,2.0")
