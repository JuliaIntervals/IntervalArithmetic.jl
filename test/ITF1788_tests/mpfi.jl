...
@testset "mpfi_abs" begin
    ...
    @test abs(RR(Float64)) == Interval(0.0, Inf)
...
@testset "mpfi_add" begin
    ...
    @test Interval(-Inf, 0.0) + Interval(+8.0, Inf) == RR(Float64)
    @test Interval(-Inf, +8.0) + Interval(0.0, +8.0) == Interval(-Inf, +16.0)
    @test RR(Float64) + Interval(0.0, +8.0) == RR(Float64)
    ...
    @test Interval(0.0, 0.0) + RR(Float64) == RR(Float64)
...
@testset "mpfi_add_d" begin
    ...
    @test RR(Float64) + Interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105) == RR(Float64)
    @test RR(Float64) + Interval(0.0e-17, 0.0e-17) == RR(Float64)
    @test RR(Float64) + Interval(+0x170ef54646d497p-105, +0x170ef54646d497p-105) == RR(Float64)
...
@testset "mpfi_asinh" begin
    ...
    @test asinh(RR(Float64)) == RR(Float64)
...
@testset "mpfi_atan" begin
    ...
    @test atan(RR(Float64)) == Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
...
@testset "mpfi_atan" begin
    ...
    @test atan(RR(Float64), Interval(0.0, +8.0)) == Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
    ...
    @test atan(Interval(0.0, 0.0), RR(Float64)) == Interval(0.0, 0x1921fb54442d19p-51)
...
@testset "mpfi_atanh" begin
    ...
    @test atanh(Interval(-1.0, 1.0)) == RR(Float64)
...
@testset "mpfi_cbrt" begin
    ...
    @test cbrt(RR(Float64)) == RR(Float64)
...
@testset "mpfi_cos" begin
    ...
    @test cos(RR(Float64)) == Interval(-1.0, 1.0)
...
@testset "mpfi_cosh" begin
    ...
    @test cosh(RR(Float64)) == Interval(1.0, Inf)
...
@testset "mpfi_cot" begin
    # special values
    @test cot(Interval(-Inf, -7.0)) == RR(Float64)
    @test cot(Interval(-Inf, 0.0)) == RR(Float64)
    @test cot(Interval(-Inf, +8.0)) == RR(Float64)
    @test cot(RR(Float64)) == RR(Float64)
    @test cot(Interval(-8.0, 0.0)) == RR(Float64)
    ...
    @test cot(Interval(0.0, +8.0)) == RR(Float64)
    @test cot(Interval(0.0, Inf)) == RR(Float64)
    # regular values
    ...
    @test cot(Interval(-2.0, 0x1921fb54442d19p-52)) == RR(Float64)
    ...
    @test cot(Interval(0x1921fb54442d19p-52, 4.0)) == RR(Float64)
...
@testset "mpfi_coth" begin
    ...
    @test coth(Interval(-Inf, +8.0)) == RR(Float64)
    @test coth(RR(Float64)) == RR(Float64)
    ...
    # regular values
    @test coth(Interval(-3.0, 2.0)) == RR(Float64)
...
@testset "mpfi_csc" begin
    # special values
    @test csc(Interval(-Inf, -7.0)) == RR(Float64)
    @test csc(Interval(-Inf, 0.0)) == RR(Float64)
    @test csc(Interval(-Inf, 8.0)) == RR(Float64)
    @test csc(RR(Float64)) == RR(Float64)
    @test csc(Interval(-8.0, 0.0)) == RR(Float64)
    ...
    @test csc(Interval(0.0, 8.0)) == RR(Float64)
    @test csc(Interval(0.0, Inf)) == RR(Float64)
    # regular values
    @test csc(Interval(-6.0, 7.0)) == RR(Float64)
    @test csc(Interval(-6.0, 6.0)) == RR(Float64)
    @test csc(Interval(-6.0, 5.0)) == RR(Float64)
    @test csc(Interval(-6.0, 4.0)) == RR(Float64)
    @test csc(Interval(-6.0, 3.0)) == RR(Float64)
    @test csc(Interval(-6.0, 2.0)) == RR(Float64)
    @test csc(Interval(-6.0, 1.0)) == RR(Float64)
    @test csc(Interval(-6.0, 0.0)) == RR(Float64)
    @test csc(Interval(-6.0, -1.0)) == RR(Float64)
    @test csc(Interval(-6.0, -2.0)) == RR(Float64)
    @test csc(Interval(-6.0, -3.0)) == RR(Float64)
    ...
    @test csc(Interval(-5.0, 7.0)) == RR(Float64)
    @test csc(Interval(-5.0, 6.0)) == RR(Float64)
    @test csc(Interval(-5.0, 5.0)) == RR(Float64)
    @test csc(Interval(-5.0, 4.0)) == RR(Float64)
    @test csc(Interval(-5.0, 3.0)) == RR(Float64)
    @test csc(Interval(-5.0, 2.0)) == RR(Float64)
    @test csc(Interval(-5.0, 1.0)) == RR(Float64)
    @test csc(Interval(-5.0, 0.0)) == RR(Float64)
    @test csc(Interval(-5.0, -1.0)) == RR(Float64)
    @test csc(Interval(-5.0, -2.0)) == RR(Float64)
    @test csc(Interval(-5.0, -3.0)) == RR(Float64)
    ...
    @test csc(Interval(-4.0, 7.0)) == RR(Float64)
    @test csc(Interval(-4.0, 6.0)) == RR(Float64)
    @test csc(Interval(-4.0, 5.0)) == RR(Float64)
    @test csc(Interval(-4.0, 4.0)) == RR(Float64)
    @test csc(Interval(-4.0, 3.0)) == RR(Float64)
    @test csc(Interval(-4.0, 2.0)) == RR(Float64)
    @test csc(Interval(-4.0, 1.0)) == RR(Float64)
    @test csc(Interval(-4.0, 0.0)) == RR(Float64)
    @test csc(Interval(-4.0, -1.0)) == RR(Float64)
    @test csc(Interval(-4.0, -2.0)) == RR(Float64)
    @test csc(Interval(-4.0, -3.0)) == RR(Float64)
    @test csc(Interval(-4.0, -4.0)) == Interval(0x15243e8b2f4641p-52, 0x15243e8b2f4642p-52)
    @test csc(Interval(-3.0, 7.0)) == RR(Float64)
    @test csc(Interval(-3.0, 6.0)) == RR(Float64)
    @test csc(Interval(-3.0, 5.0)) == RR(Float64)
    @test csc(Interval(-3.0, 4.0)) == RR(Float64)
    @test csc(Interval(-3.0, 3.0)) == RR(Float64)
    @test csc(Interval(-3.0, 2.0)) == RR(Float64)
    @test csc(Interval(-3.0, 1.0)) == RR(Float64)
    @test csc(Interval(-3.0, 0.0)) == Interval(-Inf, -1.0)
    ...
    @test csc(Interval(-2.0, 7.0)) == RR(Float64)
    @test csc(Interval(-2.0, 6.0)) == RR(Float64)
    @test csc(Interval(-2.0, 5.0)) == RR(Float64)
    @test csc(Interval(-2.0, 4.0)) == RR(Float64)
    @test csc(Interval(-2.0, 3.0)) == RR(Float64)
    @test csc(Interval(-2.0, 2.0)) == RR(Float64)
    @test csc(Interval(-2.0, 1.0)) == RR(Float64)
    ...
    @test csc(Interval(-1.0, 7.0)) == RR(Float64)
    @test csc(Interval(-1.0, 6.0)) == RR(Float64)
    @test csc(Interval(-1.0, 5.0)) == RR(Float64)
    @test csc(Interval(-1.0, 4.0)) == RR(Float64)
    @test csc(Interval(-1.0, 3.0)) == RR(Float64)
    @test csc(Interval(-1.0, 2.0)) == RR(Float64)
    @test csc(Interval(-1.0, 1.0)) == RR(Float64)
    @test csc(Interval(-1.0, 0.0)) == Interval(-Inf, -0x1303aa9620b223p-52)
...
@testset "mpfi_csch" begin
    ...
    @test csch(Interval(-Inf, +8.0)) == RR(Float64)
    @test csch(RR(Float64)) == RR(Float64)
    ...
    # regular values
    @test csch(Interval(-3.0, 2.0)) == RR(Float64)
...
@testset "mpfi_d_div" begin
    ...
    @test Interval(-0x16345785d8a00000p0, -0x16345785d8a00000p0) / Interval(-Inf, 8.0) == RR(Float64)
    @test Interval(0.0, 0.0) / Interval(-Inf, 8.0) == Interval(0.0, 0.0)
    @test Interval(0x16345785d8a00000p0, 0x16345785d8a00000p0) / Interval(-Inf, 8.0) == RR(Float64)
    @test Interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105) / RR(Float64) == RR(Float64)
    @test Interval(0.0e-17, 0.0e-17) / RR(Float64) == Interval(0.0, 0.0)
    @test Interval(+0x170ef54646d497p-105, +0x170ef54646d497p-105) / RR(Float64) == RR(Float64)
    ...
    # regular values
    @test Interval(-2.5, -2.5) / Interval(-8.0, 8.0) == RR(Float64)
...
@testset "mpfi_div" begin
    # special values
    @test Interval(-Inf, -7.0) / Interval(-1.0, +8.0) == RR(Float64)
    @test Interval(-Inf, 0.0) / Interval(+8.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-Inf, +8.0) / Interval(0.0, +8.0) == RR(Float64)
    @test RR(Float64) / Interval(0.0, +8.0) == RR(Float64)
    @test Interval(0.0, 0.0) / Interval(-Inf, -7.0) == Interval(0.0, 0.0)
    ...
    @test Interval(0.0, 0.0) / RR(Float64) == Interval(0.0, 0.0)
    @test Interval(0.0, +8.0) / Interval(-7.0, +8.0) == RR(Float64)
    @test Interval(0.0, Inf) / Interval(0.0, +8.0) == Interval(0.0, Inf)
    # regular value
    ...
    @test Interval(-0x1.25f2d73472753p+0, -0x9.9a19fd3c1fc18p-4) / Interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4) == RR(Float64)
    ...
    @test Interval(-0x1.25f2d73472753p+0, 0.0) / Interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4) == RR(Float64)
    ...
    @test Interval(-0xacbp+256, 0x6f9p0) / Interval(-0x7p0, 0.0) == RR(Float64)
    @test Interval(-0x1.25f2d73472753p+0, +0x9.9a19fd3c1fc18p-4) / Interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4) == RR(Float64)
    @test Interval(0.0, +15.0) / Interval(-3.0, +3.0) == RR(Float64)
    ...
    @test Interval(0.0, 0xap0) / Interval(-1.0, +1.0) == RR(Float64)
    ...
    @test Interval(5.0, 6.0) / Interval(-0x5.0d4d319a50b04p-4, 0x2.d8f51df1e322ep-4) == RR(Float64)
...
@testset "mpfi_div_d" begin
    ...
    @test RR(Float64) / Interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105) == RR(Float64)
    @test RR(Float64) / Interval(0.0e-17, 0.0e-17) == ∅
    @test RR(Float64) / Interval(+0x170ef54646d497p-105, +0x170ef54646d497p-105) == RR(Float64)
...
@testset "mpfi_d_sub" begin
    ...
    @test Interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105) - RR(Float64) == RR(Float64)
    @test Interval(0.0e-17, 0.0e-17) - RR(Float64) == RR(Float64)
    @test Interval(0x170ef54646d497p-105, 0x170ef54646d497p-105) - RR(Float64) == RR(Float64)
...
@testset "mpfi_exp" begin
    ...
    @test exp(RR(Float64)) == Interval(0.0, Inf)
...
@testset "mpfi_exp2" begin
    ...
    @test exp2(RR(Float64)) == Interval(0.0, Inf)
...
@testset "mpfi_expm1" begin
    ...
    @test expm1(RR(Float64)) == Interval(-1.0, Inf)
...
@testset "mpfi_hypot" begin
    ...
    @test hypot(RR(Float64), Interval(0.0, 8.0)) == Interval(0.0, Inf)
    ...
    @test hypot(Interval(0.0, 0.0), RR(Float64)) == Interval(0.0, Inf)
...
@testset "mpfi_intersect" begin
    ...
    @test (Interval(-Inf, +8.0) ∩ Interval(0.0, +8.0)) == Interval(0.0, +8.0)
    @test intersect(RR(Float64), Interval(0.0, +8.0)) == Interval(0.0, +8.0)
    @test ∩(RR(Float64), Interval(0.0, +8.0)) == Interval(0.0, +8.0)
    @test (RR(Float64) ∩ Interval(0.0, +8.0)) == Interval(0.0, +8.0)
    ...
    @test (Interval(0.0, 0.0) ∩ Interval(+8.0, Inf)) == ∅
    @test intersect(Interval(0.0, 0.0), RR(Float64)) == Interval(0.0, 0.0)
    @test ∩(Interval(0.0, 0.0), RR(Float64)) == Interval(0.0, 0.0)
    @test (Interval(0.0, 0.0) ∩ RR(Float64)) == Interval(0.0, 0.0)
...
@testset "mpfi_inv" begin
    ...
    @test inv(Interval(-Inf, +4.0)) == RR(Float64)
    @test (Interval(-Inf, +4.0))^(-1) == RR(Float64)
    @test (Interval(-Inf, +4.0))^(-1//1) == RR(Float64)
    @test (Interval(-Inf, +4.0))^(-1.0) == RR(Float64)
    @test 1 /(Interval(-Inf, +4.0)) == RR(Float64)
    @test inv(RR(Float64)) == RR(Float64)
    @test (RR(Float64))^(-1) == RR(Float64)
    @test (RR(Float64))^(-1//1) == RR(Float64)
    @test (RR(Float64))^(-1.0) == RR(Float64)
    @test 1 /(RR(Float64)) == RR(Float64)
...
@testset "mpfi_is_neg" begin
    ...
    @test precedes(RR(Float64), Interval(0.0, 0.0)) == false
...
@testset "mpfi_is_nonneg" begin
    ...
    @test (Interval(0.0, 0.0) ≤ Interval(-Inf, 5.0)) == false
    @test ≤(Interval(0.0, 0.0), RR(Float64)) == false
    @test (Interval(0.0, 0.0) ≤ RR(Float64)) == false
...
@testset "mpfi_is_nonpos" begin
    ...
    @test (Interval(-Inf, 5.0) ≤ Interval(0.0, 0.0)) == false
    @test ≤(RR(Float64), Interval(0.0, 0.0)) == false
    @test (RR(Float64) ≤ Interval(0.0, 0.0)) == false
...
@testset "mpfi_is_pos" begin
    ...
    @test precedes(Interval(0.0, 0.0), RR(Float64)) == false
...
@testset "mpfi_is_strictly_neg" begin
    ...
    @test strictprecedes(RR(Float64), Interval(0.0, 0.0)) == false
...
@testset "mpfi_is_strictly_pos" begin
    ...
    @test strictprecedes(Interval(0.0, 0.0), RR(Float64)) == false
...
@testset "mpfi_log" begin
    ...
    @test log(Interval(0.0, Inf)) == RR(Float64)
    # regular values
...
@testset "mpfi_log2" begin
    ...
    @test log2(Interval(0.0, Inf)) == RR(Float64)
    # regular values
...
@testset "mpfi_log10" begin
    ...
    @test log10(Interval(0.0, Inf)) == RR(Float64)
    # regular values
...
@testset "mpfi_mul" begin
    ...
    @test RR(Float64) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test RR(Float64) * Interval(0.0, +8.0) == RR(Float64)
    @test Interval(0.0, 0.0) * Interval(-Inf, -7.0) == Interval(0.0, 0.0)
...
@testset "mpfi_mul_d" begin
    ...
    @test RR(Float64) * Interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105) == RR(Float64)
    @test RR(Float64) * Interval(0.0e-17, 0.0e-17) == Interval(0.0, 0.0)
    @test RR(Float64) * Interval(+0x170ef54646d497p-105, +0x170ef54646d497p-105) == RR(Float64)
    @test Interval(0.0, 0.0) * Interval(-0x170ef54646d497p-109, -0x170ef54646d497p-109) == Interval(0.0, 0.0)
    @test Interval(0.0, 0.0) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test Interval(0.0, 0.0) * Interval(0x170ef54646d497p-109, 0x170ef54646d497p-109) == Interval(0.0, 0.0)
...
@testset "mpfi_sec" begin
    # special values
    @test sec(Interval(-Inf, -7.0)) == RR(Float64)
    @test sec(Interval(-Inf, 0.0)) == RR(Float64)
    @test sec(Interval(-Inf, 8.0)) == RR(Float64)
    @test sec(RR(Float64)) == RR(Float64)
    @test sec(Interval(-8.0, 0.0)) == RR(Float64)
    @test sec(Interval(-3.0, 0.0)) == RR(Float64)
    ...
    @test sec(Interval(0.0, 3.0)) == RR(Float64)
    @test sec(Interval(0.0, 8.0)) == RR(Float64)
    @test sec(Interval(0.0, Inf)) == RR(Float64)
    # regular values
    @test sec(Interval(-6.0, 7.0)) == RR(Float64)
    @test sec(Interval(-6.0, 6.0)) == RR(Float64)
    @test sec(Interval(-6.0, 5.0)) == RR(Float64)
    @test sec(Interval(-6.0, 4.0)) == RR(Float64)
    @test sec(Interval(-6.0, 3.0)) == RR(Float64)
    @test sec(Interval(-6.0, 2.0)) == RR(Float64)
    @test sec(Interval(-6.0, 1.0)) == RR(Float64)
    @test sec(Interval(-6.0, 0.0)) == RR(Float64)
    @test sec(Interval(-6.0, -1.0)) == RR(Float64)
    @test sec(Interval(-6.0, -2.0)) == RR(Float64)
    @test sec(Interval(-6.0, -3.0)) == RR(Float64)
    @test sec(Interval(-6.0, -4.0)) == RR(Float64)
    ...
    @test sec(Interval(-5.0, 7.0)) == RR(Float64)
    @test sec(Interval(-5.0, 6.0)) == RR(Float64)
    @test sec(Interval(-5.0, 5.0)) == RR(Float64)
    @test sec(Interval(-5.0, 4.0)) == RR(Float64)
    @test sec(Interval(-5.0, 3.0)) == RR(Float64)
    @test sec(Interval(-5.0, 2.0)) == RR(Float64)
    @test sec(Interval(-5.0, 1.0)) == RR(Float64)
    @test sec(Interval(-5.0, 0.0)) == RR(Float64)
    @test sec(Interval(-5.0, -1.0)) == RR(Float64)
    @test sec(Interval(-5.0, -2.0)) == RR(Float64)
    @test sec(Interval(-5.0, -3.0)) == RR(Float64)
    @test sec(Interval(-5.0, -4.0)) == RR(Float64)
    @test sec(Interval(-5.0, -5.0)) == Interval(0x1c33db0464189ap-51, 0x1c33db0464189bp-51)
    @test sec(Interval(-4.0, 7.0)) == RR(Float64)
    @test sec(Interval(-4.0, 6.0)) == RR(Float64)
    @test sec(Interval(-4.0, 5.0)) == RR(Float64)
    @test sec(Interval(-4.0, 4.0)) == RR(Float64)
    @test sec(Interval(-4.0, 3.0)) == RR(Float64)
    @test sec(Interval(-4.0, 2.0)) == RR(Float64)
    @test sec(Interval(-4.0, 1.0)) == RR(Float64)
    @test sec(Interval(-4.0, 0.0)) == RR(Float64)
    @test sec(Interval(-4.0, -1.0)) == RR(Float64)
    ...
    @test sec(Interval(-3.0, 7.0)) == RR(Float64)
    @test sec(Interval(-3.0, 6.0)) == RR(Float64)
    @test sec(Interval(-3.0, 5.0)) == RR(Float64)
    @test sec(Interval(-3.0, 4.0)) == RR(Float64)
    @test sec(Interval(-3.0, 3.0)) == RR(Float64)
    @test sec(Interval(-3.0, 2.0)) == RR(Float64)
    @test sec(Interval(-3.0, 1.0)) == RR(Float64)
    @test sec(Interval(-3.0, 0.0)) == RR(Float64)
    @test sec(Interval(-3.0, -1.0)) == RR(Float64)
    ...
    @test sec(Interval(-2.0, 7.0)) == RR(Float64)
    @test sec(Interval(-2.0, 6.0)) == RR(Float64)
    @test sec(Interval(-2.0, 5.0)) == RR(Float64)
    @test sec(Interval(-2.0, 4.0)) == RR(Float64)
    @test sec(Interval(-2.0, 3.0)) == RR(Float64)
    @test sec(Interval(-2.0, 2.0)) == RR(Float64)
    @test sec(Interval(-2.0, 1.0)) == RR(Float64)
    @test sec(Interval(-2.0, 0.0)) == RR(Float64)
    @test sec(Interval(-2.0, -1.0)) == RR(Float64)
    @test sec(Interval(-2.0, -2.0)) == Interval(-0x133956fecf9e49p-51, -0x133956fecf9e48p-51)
    @test sec(Interval(-1.0, 7.0)) == RR(Float64)
    @test sec(Interval(-1.0, 6.0)) == RR(Float64)
    @test sec(Interval(-1.0, 5.0)) == RR(Float64)
    @test sec(Interval(-1.0, 4.0)) == RR(Float64)
    @test sec(Interval(-1.0, 3.0)) == RR(Float64)
    @test sec(Interval(-1.0, 2.0)) == RR(Float64)
...
@testset "mpfi_sech" begin
    ...
    @test sech(RR(Float64)) == Interval(0.0, 1.0)
...
@testset "mpfi_sin" begin
    ...
    @test sin(RR(Float64)) == Interval(-1.0, 1.0)
...
@testset "mpfi_sinh" begin
    ...
    @test sinh(RR(Float64)) == RR(Float64)
...
@testset "mpfi_sqr" begin
    ...
    @test RR(Float64) ^2 == Interval(0.0, Inf)
    @test RR(Float64) ^(2//1) == Interval(0.0, Inf)
    @test RR(Float64) ^(2.0) == Interval(0.0, Inf)
...
@testset "mpfi_tan" begin
    # special values
    @test tan(Interval(-Inf, -7.0)) == RR(Float64)
    @test tan(Interval(-Inf, 0.0)) == RR(Float64)
    @test tan(Interval(-Inf, +8.0)) == RR(Float64)
    @test tan(RR(Float64)) == RR(Float64)
    ...
    @test tan(Interval(0.0, +8.0)) == RR(Float64)
    @test tan(Interval(0.0, Inf)) == RR(Float64)
    # regular values
    @test tan(Interval(0.125, 17.0)) == RR(Float64)
    @test tan(Interval(0x1921fb54442d18p-52, 0x1921fb54442d19p-52)) == RR(Float64)
    @test tan(Interval(-2.0, -0.5)) == RR(Float64)
    @test tan(Interval(-4.5, 0.625)) == RR(Float64)
    ...
    @test tan(Interval(-7.0, 7.0)) == RR(Float64)
    @test tan(Interval(-7.0, 6.0)) == RR(Float64)
    @test tan(Interval(-7.0, 5.0)) == RR(Float64)
    @test tan(Interval(-7.0, 4.0)) == RR(Float64)
    @test tan(Interval(-7.0, 3.0)) == RR(Float64)
    @test tan(Interval(-7.0, 2.0)) == RR(Float64)
    @test tan(Interval(-7.0, 1.0)) == RR(Float64)
    @test tan(Interval(-7.0, 0.0)) == RR(Float64)
    @test tan(Interval(-7.0, -1.0)) == RR(Float64)
    @test tan(Interval(-7.0, -2.0)) == RR(Float64)
    @test tan(Interval(-7.0, -3.0)) == RR(Float64)
    @test tan(Interval(-7.0, -4.0)) == RR(Float64)
    ...
    @test tan(Interval(-6.0, 7.0)) == RR(Float64)
    @test tan(Interval(-6.0, 6.0)) == RR(Float64)
    @test tan(Interval(-6.0, 5.0)) == RR(Float64)
    @test tan(Interval(-6.0, 4.0)) == RR(Float64)
    @test tan(Interval(-6.0, 3.0)) == RR(Float64)
    @test tan(Interval(-6.0, 2.0)) == RR(Float64)
    @test tan(Interval(-6.0, 1.0)) == RR(Float64)
    @test tan(Interval(-6.0, 0.0)) == RR(Float64)
    @test tan(Interval(-6.0, -1.0)) == RR(Float64)
    @test tan(Interval(-6.0, -2.0)) == RR(Float64)
    @test tan(Interval(-6.0, -3.0)) == RR(Float64)
    @test tan(Interval(-6.0, -4.0)) == RR(Float64)
    ...
    @test tan(Interval(-5.0, 7.0)) == RR(Float64)
    @test tan(Interval(-5.0, 6.0)) == RR(Float64)
    @test tan(Interval(-5.0, 5.0)) == RR(Float64)
    @test tan(Interval(-5.0, 4.0)) == RR(Float64)
    @test tan(Interval(-5.0, 3.0)) == RR(Float64)
    @test tan(Interval(-5.0, 2.0)) == RR(Float64)
    @test tan(Interval(-5.0, 1.0)) == RR(Float64)
    @test tan(Interval(-5.0, 0.0)) == RR(Float64)
    @test tan(Interval(-5.0, -1.0)) == RR(Float64)
    @test tan(Interval(-5.0, -2.0)) == RR(Float64)
    @test tan(Interval(-5.0, -3.0)) == RR(Float64)
    @test tan(Interval(-5.0, -4.0)) == RR(Float64)
    @test tan(Interval(-5.0, -5.0)) == Interval(0x1b0b4b739bbb06p-51, 0x1b0b4b739bbb07p-51)
    @test tan(Interval(-4.0, 7.0)) == RR(Float64)
    @test tan(Interval(-4.0, 6.0)) == RR(Float64)
    @test tan(Interval(-4.0, 5.0)) == RR(Float64)
    @test tan(Interval(-4.0, 4.0)) == RR(Float64)
    @test tan(Interval(-4.0, 3.0)) == RR(Float64)
    @test tan(Interval(-4.0, 2.0)) == RR(Float64)
    @test tan(Interval(-4.0, 1.0)) == RR(Float64)
    @test tan(Interval(-4.0, 0.0)) == RR(Float64)
    @test tan(Interval(-4.0, -1.0)) == RR(Float64)
    ...
    @test tan(Interval(-3.0, 7.0)) == RR(Float64)
    @test tan(Interval(-3.0, 6.0)) == RR(Float64)
    @test tan(Interval(-3.0, 5.0)) == RR(Float64)
    @test tan(Interval(-3.0, 4.0)) == RR(Float64)
    @test tan(Interval(-3.0, 3.0)) == RR(Float64)
    @test tan(Interval(-3.0, 2.0)) == RR(Float64)
    @test tan(Interval(-3.0, 1.0)) == RR(Float64)
    @test tan(Interval(-3.0, 0.0)) == RR(Float64)
    @test tan(Interval(-3.0, -1.0)) == RR(Float64)
    ...
    @test tan(Interval(-2.0, 7.0)) == RR(Float64)
    @test tan(Interval(-2.0, 6.0)) == RR(Float64)
    @test tan(Interval(-2.0, 5.0)) == RR(Float64)
    @test tan(Interval(-2.0, 4.0)) == RR(Float64)
    @test tan(Interval(-2.0, 3.0)) == RR(Float64)
    @test tan(Interval(-2.0, 2.0)) == RR(Float64)
    @test tan(Interval(-2.0, 1.0)) == RR(Float64)
    @test tan(Interval(-2.0, 0.0)) == RR(Float64)
    @test tan(Interval(-2.0, -1.0)) == RR(Float64)
    @test tan(Interval(-2.0, -2.0)) == Interval(0x117af62e0950f8p-51, 0x117af62e0950f9p-51)
    @test tan(Interval(-1.0, 7.0)) == RR(Float64)
    @test tan(Interval(-1.0, 6.0)) == RR(Float64)
    @test tan(Interval(-1.0, 5.0)) == RR(Float64)
    @test tan(Interval(-1.0, 4.0)) == RR(Float64)
    @test tan(Interval(-1.0, 3.0)) == RR(Float64)
    @test tan(Interval(-1.0, 2.0)) == RR(Float64)
...
@testset "mpfi_tanh" begin
    ...
    @test tanh(RR(Float64)) == Interval(-1.0, +1.0)
...
@testset "mpfi_union" begin
    ...
    @test (Interval(-Inf, -7.0) ∪ Interval(-1.0, +8.0)) == Interval(-Inf, +8.0)
    @test hull(Interval(-Inf, 0.0), Interval(+8.0, Inf)) == RR(Float64)
    @test ∪(Interval(-Inf, 0.0), Interval(+8.0, Inf)) == RR(Float64)
    @test (Interval(-Inf, 0.0) ∪ Interval(+8.0, Inf)) == RR(Float64)
    @test hull(Interval(-Inf, +8.0), Interval(0.0, +8.0)) == Interval(-Inf, +8.0)
    @test ∪(Interval(-Inf, +8.0), Interval(0.0, +8.0)) == Interval(-Inf, +8.0)
    @test (Interval(-Inf, +8.0) ∪ Interval(0.0, +8.0)) == Interval(-Inf, +8.0)
    @test hull(RR(Float64), Interval(0.0, +8.0)) == RR(Float64)
    @test ∪(RR(Float64), Interval(0.0, +8.0)) == RR(Float64)
    @test (RR(Float64) ∪ Interval(0.0, +8.0)) == RR(Float64)
    ...
    @test (Interval(0.0, 0.0) ∪ Interval(+8.0, Inf)) == Interval(0.0, Inf)
    @test hull(Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test ∪(Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test (Interval(0.0, 0.0) ∪ RR(Float64)) == RR(Float64)
