...
@testset "minimal_pos_dec_test" begin
    ...
    @test +DecoratedInterval(RR(Float64), def) == DecoratedInterval(RR(Float64), def)
    @test decoration(+DecoratedInterval(RR(Float64), def)) == decoration(DecoratedInterval(RR(Float64), def))
...
@testset "minimal_add_test" begin
    ...
    @test ∅ + RR(Float64) == ∅
    @test RR(Float64) + ∅ == ∅
    @test RR(Float64) + Interval(-Inf, 1.0) == RR(Float64)
    @test RR(Float64) + Interval(-1.0, 1.0) == RR(Float64)
    @test RR(Float64) + Interval(-1.0, Inf) == RR(Float64)
    @test RR(Float64) + RR(Float64) == RR(Float64)
    @test Interval(-Inf, 1.0) + RR(Float64) == RR(Float64)
    @test Interval(-1.0, 1.0) + RR(Float64) == RR(Float64)
    @test Interval(-1.0, Inf) + RR(Float64) == RR(Float64)
    @test Interval(-Inf, 2.0) + Interval(-Inf, 4.0) == Interval(-Inf, 6.0)
    @test Interval(-Inf, 2.0) + Interval(3.0, 4.0) == Interval(-Inf, 6.0)
    @test Interval(-Inf, 2.0) + Interval(3.0, Inf) == RR(Float64)
    ...
    @test Interval(1.0, Inf) + Interval(-Inf, 4.0) == RR(Float64)
    ...
    @test Interval(-0x1.fffffffffffffp1023, 2.0) + Interval(-3.0, 0x1.fffffffffffffp1023) == RR(Float64)
...
@testset "minimal_sub_test" begin
    ...
    @test Interval(-1.0, 1.0) - RR(Float64) == RR(Float64)
    @test Interval(-1.0, Inf) - RR(Float64) == RR(Float64)
    @test Interval(-Inf, 2.0) - Interval(-Inf, 4.0) == RR(Float64)
    ...
    @test Interval(1.0, Inf) - Interval(3.0, Inf) == RR(Float64)
    ...
    @test Interval(-0x1.fffffffffffffp1023, 2.0) - Interval(-0x1.fffffffffffffp1023, 4.0) == RR(Float64)
    @test Interval(1.0, 0x1.fffffffffffffp1023) - Interval(0.0, 0.0) == Interval(1.0, 0x1.fffffffffffffp1023)
    @test Interval(1.0, 0x1.fffffffffffffp1023) - Interval(-0.0, -0.0) == Interval(1.0, 0x1.fffffffffffffp1023)
...
@testset "minimal_mul_test" begin
    ...
    @test RR(Float64) * Interval(-0.0, -0.0) == Interval(0.0, 0.0)
    @test RR(Float64) * Interval(-5.0, -1.0) == RR(Float64)
    @test RR(Float64) * Interval(-5.0, 3.0) == RR(Float64)
    @test RR(Float64) * Interval(1.0, 3.0) == RR(Float64)
    @test RR(Float64) * Interval(-Inf, -1.0) == RR(Float64)
    @test RR(Float64) * Interval(-Inf, 3.0) == RR(Float64)
    @test RR(Float64) * Interval(-5.0, Inf) == RR(Float64)
    @test RR(Float64) * Interval(1.0, Inf) == RR(Float64)
    @test RR(Float64) * RR(Float64) == RR(Float64)
    @test Interval(1.0, Inf) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test Interval(1.0, Inf) * Interval(-0.0, -0.0) == Interval(0.0, 0.0)
    @test Interval(1.0, Inf) * Interval(-5.0, -1.0) == Interval(-Inf, -1.0)
    @test Interval(1.0, Inf) * Interval(-5.0, 3.0) == RR(Float64)
    @test Interval(1.0, Inf) * Interval(1.0, 3.0) == Interval(1.0, Inf)
    @test Interval(1.0, Inf) * Interval(-Inf, -1.0) == Interval(-Inf, -1.0)
    @test Interval(1.0, Inf) * Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(1.0, Inf) * Interval(-5.0, Inf) == RR(Float64)
    ...
    @test Interval(-1.0, Inf) * Interval(-Inf, -1.0) == RR(Float64)
    @test Interval(-1.0, Inf) * Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-1.0, Inf) * Interval(-5.0, Inf) == RR(Float64)
    @test Interval(-1.0, Inf) * Interval(1.0, Inf) == RR(Float64)
    @test Interval(-1.0, Inf) * RR(Float64) == RR(Float64)
    @test Interval(-Inf, 3.0) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test Interval(-Inf, 3.0) * Interval(-0.0, -0.0) == Interval(0.0, 0.0)
    @test Interval(-Inf, 3.0) * Interval(-5.0, -1.0) == Interval(-15.0, Inf)
    @test Interval(-Inf, 3.0) * Interval(-5.0, 3.0) == RR(Float64)
    @test Interval(-Inf, 3.0) * Interval(1.0, 3.0) == Interval(-Inf, 9.0)
    @test Interval(-Inf, 3.0) * Interval(-Inf, -1.0) == RR(Float64)
    @test Interval(-Inf, 3.0) * Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-Inf, 3.0) * Interval(-5.0, Inf) == RR(Float64)
    @test Interval(-Inf, 3.0) * Interval(1.0, Inf) == RR(Float64)
    @test Interval(-Inf, 3.0) * RR(Float64) == RR(Float64)
    @test Interval(-Inf, -3.0) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test Interval(-Inf, -3.0) * Interval(-0.0, -0.0) == Interval(0.0, 0.0)
    ...
    @test Interval(1.0, 5.0) * RR(Float64) == RR(Float64)
    @test Interval(-1.0, 5.0) * Interval(0.0, 0.0) == Interval(0.0, 0.0)
    @test Interval(-1.0, 5.0) * Interval(-0.0, -0.0) == Interval(0.0, 0.0)
    ...
    @test Interval(-1.0, 5.0) * Interval(-Inf, -1.0) == RR(Float64)
    @test Interval(-1.0, 5.0) * Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-1.0, 5.0) * Interval(-5.0, Inf) == RR(Float64)
    @test Interval(-1.0, 5.0) * Interval(1.0, Inf) == RR(Float64)
    @test Interval(-1.0, 5.0) * RR(Float64) == RR(Float64)
    ...
    @test Interval(-10.0, -5.0) * RR(Float64) == RR(Float64)
...
@testset "minimal_div_test" begin
    ...
    @test ∅ / Interval(-0.0, -0.0) == ∅
    @test RR(Float64) / Interval(-5.0, -3.0) == RR(Float64)
    @test RR(Float64) / Interval(3.0, 5.0) == RR(Float64)
    @test RR(Float64) / Interval(-Inf, -3.0) == RR(Float64)
    @test RR(Float64) / Interval(3.0, Inf) == RR(Float64)
    @test RR(Float64) / Interval(0.0, 0.0) == ∅
    @test RR(Float64) / Interval(-0.0, -0.0) == ∅
    @test RR(Float64) / Interval(-3.0, 0.0) == RR(Float64)
    @test RR(Float64) / Interval(-3.0, -0.0) == RR(Float64)
    @test RR(Float64) / Interval(-3.0, 3.0) == RR(Float64)
    @test RR(Float64) / Interval(0.0, 3.0) == RR(Float64)
    @test RR(Float64) / Interval(-Inf, 0.0) == RR(Float64)
    @test RR(Float64) / Interval(-0.0, 3.0) == RR(Float64)
    @test RR(Float64) / Interval(-Inf, -0.0) == RR(Float64)
    @test RR(Float64) / Interval(-Inf, 3.0) == RR(Float64)
    @test RR(Float64) / Interval(-3.0, Inf) == RR(Float64)
    @test RR(Float64) / Interval(0.0, Inf) == RR(Float64)
    @test RR(Float64) / Interval(-0.0, Inf) == RR(Float64)
    @test RR(Float64) / RR(Float64) == RR(Float64)
    ...
    @test Interval(-30.0, -15.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-30.0, -15.0) / Interval(-3.0, -0.0) == Interval(5.0, Inf)
    @test Interval(-30.0, -15.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-30.0, -15.0) / Interval(0.0, 3.0) == Interval(-Inf, -5.0)
    @test Interval(-30.0, -15.0) / Interval(-Inf, 0.0) == Interval(0.0, Inf)
    @test Interval(-30.0, -15.0) / Interval(-0.0, 3.0) == Interval(-Inf, -5.0)
    @test Interval(-30.0, -15.0) / Interval(-Inf, -0.0) == Interval(0.0, Inf)
    @test Interval(-30.0, -15.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-30.0, -15.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-30.0, -15.0) / Interval(0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-30.0, -15.0) / Interval(-0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-30.0, -15.0) / RR(Float64) == RR(Float64)
    ...
    @test Interval(-30.0, 15.0) / Interval(0.0, 0.0) == ∅
    @test Interval(-30.0, 15.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-30.0, 15.0) / Interval(-3.0, 0.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-3.0, -0.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(0.0, 3.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-Inf, 0.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-0.0, 3.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-Inf, -0.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(0.0, Inf) == RR(Float64)
    @test Interval(-30.0, 15.0) / Interval(-0.0, Inf) == RR(Float64)
    @test Interval(-30.0, 15.0) / RR(Float64) == RR(Float64)
    ...
    @test Interval(15.0, 30.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(15.0, 30.0) / Interval(-3.0, -0.0) == Interval(-Inf, -5.0)
    @test Interval(15.0, 30.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(15.0, 30.0) / Interval(0.0, 3.0) == Interval(5.0, Inf)
    @test Interval(15.0, 30.0) / Interval(-Inf, 0.0) == Interval(-Inf, 0.0)
    @test Interval(15.0, 30.0) / Interval(-0.0, 3.0) == Interval(5.0, Inf)
    @test Interval(15.0, 30.0) / Interval(-Inf, -0.0) == Interval(-Inf, 0.0)
    @test Interval(15.0, 30.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(15.0, 30.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(15.0, 30.0) / Interval(0.0, Inf) == Interval(0.0, Inf)
    @test Interval(15.0, 30.0) / Interval(-0.0, Inf) == Interval(0.0, Inf)
    @test Interval(15.0, 30.0) / RR(Float64) == RR(Float64)
    @test Interval(0.0, 0.0) / Interval(-5.0, -3.0) == Interval(0.0, 0.0)
    ...
    @test Interval(-Inf, -15.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-Inf, -15.0) / Interval(-3.0, -0.0) == Interval(5.0, Inf)
    @test Interval(-Inf, -15.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-Inf, -15.0) / Interval(0.0, 3.0) == Interval(-Inf, -5.0)
    @test Interval(-Inf, -15.0) / Interval(-Inf, 0.0) == Interval(0.0, Inf)
    @test Interval(-Inf, -15.0) / Interval(-0.0, 3.0) == Interval(-Inf, -5.0)
    @test Interval(-Inf, -15.0) / Interval(-Inf, -0.0) == Interval(0.0, Inf)
    @test Interval(-Inf, -15.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-Inf, -15.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-Inf, -15.0) / Interval(0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-Inf, -15.0) / Interval(-0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-Inf, -15.0) / RR(Float64) == RR(Float64)
    ...
    @test Interval(-Inf, 15.0) / Interval(0.0, 0.0) == ∅
    @test Interval(-Inf, 15.0) / Interval(-3.0, 0.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-Inf, 15.0) / Interval(-3.0, -0.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(0.0, 3.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-Inf, 0.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-0.0, 3.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-Inf, -0.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(0.0, Inf) == RR(Float64)
    @test Interval(-Inf, 15.0) / Interval(-0.0, Inf) == RR(Float64)
    @test Interval(-Inf, 15.0) / RR(Float64) == RR(Float64)
    ...
    @test Interval(-15.0, Inf) / Interval(-3.0, 0.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-0.0, -0.0) == ∅
    @test Interval(-15.0, Inf) / Interval(-3.0, -0.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(0.0, 3.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-Inf, 0.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-0.0, 3.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-Inf, -0.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(0.0, Inf) == RR(Float64)
    @test Interval(-15.0, Inf) / Interval(-0.0, Inf) == RR(Float64)
    @test Interval(-15.0, Inf) / RR(Float64) == RR(Float64)
    ...
    @test Interval(-30.0, 0.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-30.0, 0.0) / Interval(-3.0, -0.0) == Interval(0.0, Inf)
    @test Interval(-30.0, 0.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-30.0, 0.0) / Interval(0.0, 3.0) == Interval(-Inf, 0.0)
    @test Interval(-30.0, 0.0) / Interval(-Inf, 0.0) == Interval(0.0, Inf)
    @test Interval(-30.0, 0.0) / Interval(-0.0, 3.0) == Interval(-Inf, 0.0)
    @test Interval(-30.0, 0.0) / Interval(-Inf, -0.0) == Interval(0.0, Inf)
    @test Interval(-30.0, 0.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-30.0, 0.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-30.0, 0.0) / Interval(0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-30.0, 0.0) / Interval(-0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-30.0, 0.0) / RR(Float64) == RR(Float64)
    @test Interval(-30.0, -0.0) / Interval(-5.0, -3.0) == Interval(0.0, 10.0)
    @test Interval(-30.0, -0.0) / Interval(3.0, 5.0) == Interval(-10.0, 0.0)
    @test Interval(-30.0, -0.0) / Interval(-Inf, -3.0) == Interval(0.0, 10.0)
    @test Interval(-30.0, -0.0) / Interval(3.0, Inf) == Interval(-10.0, 0.0)
    ...
    @test Interval(0.0, 30.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(0.0, 30.0) / Interval(-3.0, -0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, 30.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(0.0, 30.0) / Interval(0.0, 3.0) == Interval(0.0, Inf)
    @test Interval(0.0, 30.0) / Interval(-Inf, 0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, 30.0) / Interval(-0.0, 3.0) == Interval(0.0, Inf)
    @test Interval(0.0, 30.0) / Interval(-Inf, -0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, 30.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(0.0, 30.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(0.0, 30.0) / Interval(0.0, Inf) == Interval(0.0, Inf)
    @test Interval(0.0, 30.0) / Interval(-0.0, Inf) == Interval(0.0, Inf)
    @test Interval(0.0, 30.0) / RR(Float64) == RR(Float64)
    @test Interval(-0.0, 30.0) / Interval(-5.0, -3.0) == Interval(-10.0, 0.0)
    @test Interval(-0.0, 30.0) / Interval(3.0, 5.0) == Interval(0.0, 10.0)
    @test Interval(-0.0, 30.0) / Interval(-Inf, -3.0) == Interval(-10.0, 0.0)
    @test Interval(-0.0, 30.0) / Interval(3.0, Inf) == Interval(0.0, 10.0)
    ...
    @test Interval(-Inf, 0.0) / Interval(-0.0, -0.0) == ∅
    @test Interval(-Inf, 0.0) / Interval(-3.0, -0.0) == Interval(0.0, Inf)
    @test Interval(-Inf, 0.0) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(-Inf, 0.0) / Interval(0.0, 3.0) == Interval(-Inf, 0.0)
    @test Interval(-Inf, 0.0) / Interval(-Inf, 0.0) == Interval(0.0, Inf)
    @test Interval(-Inf, 0.0) / Interval(-0.0, 3.0) == Interval(-Inf, 0.0)
    @test Interval(-Inf, 0.0) / Interval(-Inf, -0.0) == Interval(0.0, Inf)
    @test Interval(-Inf, 0.0) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(-Inf, 0.0) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(-Inf, 0.0) / Interval(0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-Inf, 0.0) / Interval(-0.0, Inf) == Interval(-Inf, 0.0)
    @test Interval(-Inf, 0.0) / RR(Float64) == RR(Float64)
    @test Interval(-Inf, -0.0) / Interval(-5.0, -3.0) == Interval(0.0, Inf)
    @test Interval(-Inf, -0.0) / Interval(3.0, 5.0) == Interval(-Inf, 0.0)
    @test Interval(-Inf, -0.0) / Interval(-Inf, -3.0) == Interval(0.0, Inf)
    @test Interval(-Inf, -0.0) / Interval(3.0, Inf) == Interval(-Inf, 0.0)
    ...
    @test Interval(0.0, Inf) / Interval(-0.0, -0.0) == ∅
    @test Interval(0.0, Inf) / Interval(-3.0, -0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, Inf) / Interval(-3.0, 3.0) == RR(Float64)
    @test Interval(0.0, Inf) / Interval(0.0, 3.0) == Interval(0.0, Inf)
    @test Interval(0.0, Inf) / Interval(-Inf, 0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, Inf) / Interval(-0.0, 3.0) == Interval(0.0, Inf)
    @test Interval(0.0, Inf) / Interval(-Inf, -0.0) == Interval(-Inf, 0.0)
    @test Interval(0.0, Inf) / Interval(-Inf, 3.0) == RR(Float64)
    @test Interval(0.0, Inf) / Interval(-3.0, Inf) == RR(Float64)
    @test Interval(0.0, Inf) / Interval(0.0, Inf) == Interval(0.0, Inf)
    @test Interval(0.0, Inf) / Interval(-0.0, Inf) == Interval(0.0, Inf)
    @test Interval(0.0, Inf) / RR(Float64) == RR(Float64)
    @test Interval(-0.0, Inf) / Interval(-5.0, -3.0) == Interval(-Inf, 0.0)
    @test Interval(-0.0, Inf) / Interval(3.0, 5.0) == Interval(0.0, Inf)
    @test Interval(-0.0, Inf) / Interval(-Inf, -3.0) == Interval(-Inf, 0.0)
    @test Interval(-0.0, Inf) / Interval(3.0, Inf) == Interval(0.0, Inf)
...
@testset "minimal_recip_test" begin
    ...
    @test (Interval(-10.0, -0.0))^(-1.0) == Interval(-Inf, -0x1.9999999999999p-4)
    @test 1 /(Interval(-10.0, -0.0)) == Interval(-Inf, -0x1.9999999999999p-4)
    @test inv(Interval(-10.0, 10.0)) == RR(Float64)
    @test (Interval(-10.0, 10.0))^(-1) == RR(Float64)
    @test (Interval(-10.0, 10.0))^(-1//1) == RR(Float64)
    @test (Interval(-10.0, 10.0))^(-1.0) == RR(Float64)
    @test 1 /(Interval(-10.0, 10.0)) == RR(Float64)
    ...
    @test (Interval(-Inf, -0.0))^(-1.0) == Interval(-Inf, 0.0)
    @test 1 /(Interval(-Inf, -0.0)) == Interval(-Inf, 0.0)
    @test inv(Interval(-Inf, 10.0)) == RR(Float64)
    @test (Interval(-Inf, 10.0))^(-1) == RR(Float64)
    @test (Interval(-Inf, 10.0))^(-1//1) == RR(Float64)
    @test (Interval(-Inf, 10.0))^(-1.0) == RR(Float64)
    @test 1 /(Interval(-Inf, 10.0)) == RR(Float64)
    @test inv(Interval(-10.0, Inf)) == RR(Float64)
    @test (Interval(-10.0, Inf))^(-1) == RR(Float64)
    @test (Interval(-10.0, Inf))^(-1//1) == RR(Float64)
    @test (Interval(-10.0, Inf))^(-1.0) == RR(Float64)
    @test 1 /(Interval(-10.0, Inf)) == RR(Float64)
...
@testset "minimal_recip_dec_test" begin
    ...
    @test inv(DecoratedInterval(Interval(-10.0, Inf), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(inv(DecoratedInterval(Interval(-10.0, Inf), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(Interval(-10.0, Inf), dac))^(-1) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(Interval(-10.0, Inf), dac))^(-1)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(Interval(-10.0, Inf), dac))^(-1//1) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(Interval(-10.0, Inf), dac))^(-1//1)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(Interval(-10.0, Inf), dac))^(-1.0) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(Interval(-10.0, Inf), dac))^(-1.0)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test 1 /(DecoratedInterval(Interval(-10.0, Inf), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(1 /(DecoratedInterval(Interval(-10.0, Inf), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    ...
    @test inv(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(inv(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(RR(Float64), def))^(-1) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(RR(Float64), def))^(-1)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(RR(Float64), def))^(-1//1) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(RR(Float64), def))^(-1//1)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test (DecoratedInterval(RR(Float64), def))^(-1.0) == DecoratedInterval(RR(Float64), trv)
    @test decoration((DecoratedInterval(RR(Float64), def))^(-1.0)) == decoration(DecoratedInterval(RR(Float64), trv))
    @test 1 /(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(1 /(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(RR(Float64), trv))
end
...
@testset "minimal_sqrt_test" begin
    ...
    @test (∅)^(0.5) == ∅
    @test (∅)^(1//2) == ∅
    @test sqrt(RR(Float64)) == Interval(0.0, Inf)
    @test (RR(Float64))^(1/2) == Interval(0.0, Inf)
    @test (RR(Float64))^(0.5) == Interval(0.0, Inf)
    @test (RR(Float64))^(1//2) == Interval(0.0, Inf)
...
@testset "minimal_fma_test" begin
    ...
    @test fma(∅, Interval(0.0, 0.0), ∅) == ∅
    @test fma(∅, Interval(-0.0, -0.0), ∅) == ∅
    @test fma(RR(Float64), Interval(0.0, 0.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-0.0, -0.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-5.0, -1.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-5.0, 3.0), ∅) == ∅
    @test fma(RR(Float64), Interval(1.0, 3.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-Inf, -1.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-Inf, 3.0), ∅) == ∅
    @test fma(RR(Float64), Interval(-5.0, Inf), ∅) == ∅
    @test fma(RR(Float64), Interval(1.0, Inf), ∅) == ∅
    @test fma(RR(Float64), RR(Float64), ∅) == ∅
    ...
    @test fma(Interval(1.0, Inf), RR(Float64), ∅) == ∅
    @test fma(Interval(-1.0, Inf), Interval(0.0, 0.0), ∅) == ∅
    @test fma(Interval(-1.0, Inf), Interval(-0.0, -0.0), ∅) == ∅
    @test fma(Interval(-1.0, Inf), Interval(-5.0, -1.0), ∅) == ∅
    @test fma(Interval(-1.0, Inf), Interval(-5.0, 3.0), ∅) == ∅
    ...
    @test fma(Interval(-Inf, 3.0), RR(Float64), ∅) == ∅
    @test fma(Interval(-Inf, -3.0), Interval(0.0, 0.0), ∅) == ∅
    @test fma(Interval(-Inf, -3.0), Interval(-0.0, -0.0), ∅) == ∅
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, -1.0), ∅) == ∅
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, 3.0), ∅) == ∅
    ...
    @test fma(Interval(0.0, 0.0), RR(Float64), ∅) == ∅
    @test fma(Interval(-0.0, -0.0), Interval(0.0, 0.0), ∅) == ∅
    @test fma(Interval(-0.0, -0.0), Interval(-0.0, -0.0), ∅) == ∅
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, -1.0), ∅) == ∅
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, 3.0), ∅) == ∅
    ...
    @test fma(Interval(1.0, 5.0), RR(Float64), ∅) == ∅
    @test fma(Interval(-1.0, 5.0), Interval(0.0, 0.0), ∅) == ∅
    @test fma(Interval(-1.0, 5.0), Interval(-0.0, -0.0), ∅) == ∅
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, -1.0), ∅) == ∅
    #min max
    ...
    @test fma(Interval(-10.0, -5.0), RR(Float64), ∅) == ∅
    @test fma(∅, ∅, Interval(-Inf, 2.0)) == ∅
    @test fma(Interval(-1.0, 1.0), ∅, Interval(-Inf, 2.0)) == ∅
    @test fma(∅, Interval(-1.0, 1.0), Interval(-Inf, 2.0)) == ∅
    @test fma(∅, RR(Float64), Interval(-Inf, 2.0)) == ∅
    @test fma(RR(Float64), ∅, Interval(-Inf, 2.0)) == ∅
    @test fma(Interval(0.0, 0.0), ∅, Interval(-Inf, 2.0)) == ∅
    @test fma(Interval(-0.0, -0.0), ∅, Interval(-Inf, 2.0)) == ∅
    @test fma(∅, Interval(0.0, 0.0), Interval(-Inf, 2.0)) == ∅
    @test fma(∅, Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == ∅
    @test fma(RR(Float64), Interval(0.0, 0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(RR(Float64), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(RR(Float64), Interval(-5.0, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(RR(Float64), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(1.0, Inf), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == Interval(-Inf, 1.0)
    @test fma(Interval(1.0, Inf), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(0.0, 0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-1.0, Inf), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, -1.0), Interval(-Inf, 2.0)) == Interval(-Inf, 7.0)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(1.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(-Inf, 3.0), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, 3.0), Interval(-Inf, 2.0)) == Interval(-Inf, 11.0)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(0.0, 0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-Inf, -3.0), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(0.0, 0.0), RR(Float64), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(0.0, 0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, -1.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, 3.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    ...
    @test fma(Interval(1.0, 5.0), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(0.0, 0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    @test fma(Interval(-1.0, 5.0), Interval(-0.0, -0.0), Interval(-Inf, 2.0)) == Interval(-Inf, 2.0)
    ...
    #end min max
    @test fma(Interval(-1.0, 5.0), Interval(1.0, 3.0), Interval(-Inf, 2.0)) == Interval(-Inf, 17.0)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(1.0, Inf), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(-10.0, -5.0), Interval(-Inf, -1.0), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-Inf, 3.0), Interval(-Inf, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(-10.0, -5.0), RR(Float64), Interval(-Inf, 2.0)) == RR(Float64)
    @test fma(∅, ∅, Interval(-2.0, 2.0)) == ∅
    @test fma(Interval(-1.0, 1.0), ∅, Interval(-2.0, 2.0)) == ∅
    @test fma(∅, Interval(-1.0, 1.0), Interval(-2.0, 2.0)) == ∅
    @test fma(∅, RR(Float64), Interval(-2.0, 2.0)) == ∅
    @test fma(RR(Float64), ∅, Interval(-2.0, 2.0)) == ∅
    @test fma(Interval(0.0, 0.0), ∅, Interval(-2.0, 2.0)) == ∅
    @test fma(Interval(-0.0, -0.0), ∅, Interval(-2.0, 2.0)) == ∅
    @test fma(∅, Interval(0.0, 0.0), Interval(-2.0, 2.0)) == ∅
    @test fma(∅, Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == ∅
    @test fma(RR(Float64), Interval(0.0, 0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(RR(Float64), Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(RR(Float64), Interval(-5.0, -1.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, -1.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(RR(Float64), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(1.0, Inf), Interval(-5.0, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(1.0, Inf), Interval(-Inf, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, Inf), Interval(-2.0, 2.0)) == Interval(-1.0, Inf)
    @test fma(Interval(1.0, Inf), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(0.0, 0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-1.0, Inf), Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    ...
    @test fma(Interval(-1.0, Inf), Interval(-Inf, -1.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-Inf, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(1.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, 3.0), Interval(-2.0, 2.0)) == Interval(-Inf, 11.0)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, -1.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(0.0, 0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-Inf, -3.0), Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    ...
    @test fma(Interval(0.0, 0.0), RR(Float64), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(0.0, 0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, -1.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, 3.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    ...
    @test fma(Interval(1.0, 5.0), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(0.0, 0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    @test fma(Interval(-1.0, 5.0), Interval(-0.0, -0.0), Interval(-2.0, 2.0)) == Interval(-2.0, 2.0)
    ...
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, -1.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, 3.0), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(1.0, Inf), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    ...
    @test fma(Interval(-10.0, -5.0), RR(Float64), Interval(-2.0, 2.0)) == RR(Float64)
    @test fma(∅, ∅, Interval(-2.0, Inf)) == ∅
    @test fma(Interval(-1.0, 1.0), ∅, Interval(-2.0, Inf)) == ∅
    @test fma(∅, Interval(-1.0, 1.0), Interval(-2.0, Inf)) == ∅
    @test fma(∅, RR(Float64), Interval(-2.0, Inf)) == ∅
    @test fma(RR(Float64), ∅, Interval(-2.0, Inf)) == ∅
    @test fma(Interval(0.0, 0.0), ∅, Interval(-2.0, Inf)) == ∅
    @test fma(Interval(-0.0, -0.0), ∅, Interval(-2.0, Inf)) == ∅
    @test fma(∅, Interval(0.0, 0.0), Interval(-2.0, Inf)) == ∅
    @test fma(∅, Interval(-0.0, -0.0), Interval(-2.0, Inf)) == ∅
    @test fma(RR(Float64), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(RR(Float64), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(RR(Float64), Interval(-5.0, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(RR(Float64), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(1.0, Inf), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(1.0, Inf), Interval(-5.0, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, 3.0), Interval(-2.0, Inf)) == Interval(-1.0, Inf)
    @test fma(Interval(1.0, Inf), Interval(-Inf, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, Inf), Interval(-2.0, Inf)) == Interval(-1.0, Inf)
    @test fma(Interval(1.0, Inf), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-1.0, Inf), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    ...
    @test fma(Interval(-1.0, Inf), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(1.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    ...
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-Inf, -3.0), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    ...
    @test fma(Interval(0.0, 0.0), RR(Float64), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-0.0, -0.0), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-0.0, -0.0), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, -1.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, 3.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    ...
    @test fma(Interval(1.0, 5.0), Interval(-Inf, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    ...
    @test fma(Interval(1.0, 5.0), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-0.0, -0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-1.0, 5.0), Interval(0.0, 0.0), Interval(-2.0, Inf)) == Interval(-2.0, Inf)
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, -1.0), Interval(-2.0, Inf)) == Interval(-27.0, Inf)
    #min max
    ...
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, -1.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, 3.0), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(1.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    ...
    @test fma(Interval(-10.0, -5.0), Interval(-5.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(1.0, Inf), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), RR(Float64), Interval(-2.0, Inf)) == RR(Float64)
    @test fma(∅, ∅, RR(Float64)) == ∅
    @test fma(Interval(-1.0, 1.0), ∅, RR(Float64)) == ∅
    @test fma(∅, Interval(-1.0, 1.0), RR(Float64)) == ∅
    @test fma(∅, RR(Float64), RR(Float64)) == ∅
    @test fma(RR(Float64), ∅, RR(Float64)) == ∅
    @test fma(Interval(0.0, 0.0), ∅, RR(Float64)) == ∅
    ...
    @test fma(∅, Interval(0.0, 0.0), RR(Float64)) == ∅
    @test fma(∅, Interval(-0.0, -0.0), RR(Float64)) == ∅
    @test fma(RR(Float64), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(RR(Float64), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, Inf), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    ...
    @test fma(Interval(-1.0, Inf), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, Inf), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, 3.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    ...
    @test fma(Interval(-Inf, -3.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-Inf, -3.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(0.0, 0.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-0.0, -0.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-0.0, -0.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-0.0, -0.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    ...
    @test fma(Interval(-0.0, -0.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-0.0, -0.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(1.0, 5.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    #min max
    @test fma(Interval(-1.0, 5.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, 2.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-1.0, 10.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-2.0, 2.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    #end min max
    @test fma(Interval(-1.0, 5.0), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    ...
    @test fma(Interval(-1.0, 5.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-1.0, 5.0), RR(Float64), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(0.0, 0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-0.0, -0.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-5.0, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-5.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(1.0, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-Inf, -1.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-Inf, 3.0), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(-5.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), Interval(1.0, Inf), RR(Float64)) == RR(Float64)
    @test fma(Interval(-10.0, -5.0), RR(Float64), RR(Float64)) == RR(Float64)
...
@testset "minimal_pown_test" begin
    @test ∅ ^ 0 == ∅
    @test RR(Float64) ^ 0 == Interval(1.0, 1.0)
    ...
    @test ∅ ^ 8 == ∅
    @test RR(Float64) ^ 8 == Interval(0.0, Inf)
    ...
    @test Interval(-Inf, 0.0) ^ -1 == Interval(-Inf, 0.0)
    @test Interval(-Inf, -0.0) ^ -1 == Interval(-Inf, 0.0)
    @test Interval(-324.3, 2.5) ^ -1 == RR(Float64)
    ...
    @test Interval(-Inf, 0.0) ^ -3 == Interval(-Inf, 0.0)
    @test Interval(-Inf, -0.0) ^ -3 == Interval(-Inf, 0.0)
    @test Interval(-324.3, 2.5) ^ -3 == RR(Float64)
    ...
    @test Interval(-Inf, 0.0) ^ -7 == Interval(-Inf, 0.0)
    @test Interval(-Inf, -0.0) ^ -7 == Interval(-Inf, 0.0)
    @test Interval(-324.3, 2.5) ^ -7 == RR(Float64)
...
@testset "minimal_pown_dec_test" begin
    ...
    @test DecoratedInterval(Interval(-3.0, 5.0), com) ^ -3 == DecoratedInterval(RR(Float64), trv)
    @test decoration(DecoratedInterval(Interval(-3.0, 5.0), com) ^ -3) == decoration(DecoratedInterval(RR(Float64), trv))
end
...
@testset "minimal_pow_test" begin
    ...
    @test Interval(0.1, 0.5) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(0.1, 1.0) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(0.5, 1.5) ^ RR(Float64) == Interval(0x0p+0, Inf)
    ...
    @test Interval(0.5, Inf) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(1.0, 1.5) ^ RR(Float64) == Interval(0x0p+0, Inf)
    ...
    @test Interval(1.0, Inf) ^ RR(Float64) == Interval(0x0p+0, Inf)
    ...
    @test Interval(1.1, 1.5) ^ RR(Float64) == Interval(0x0p+0, Inf)
    ...
    @test Interval(1.1, Inf) ^ RR(Float64) == Interval(0x0p+0, Inf)
    ...
    @test Interval(0.0, 0.5) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(0.0, 1.0) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(0.0, 1.5) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(0.0, Inf) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(-0.1, 1.5) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(-0.1, Inf) ^ RR(Float64) == Interval(0.0, Inf)
    ...
    @test Interval(-1.0, 0.0) ^ RR(Float64) == Interval(0.0, 0.0)
    ...
    @test Interval(-1.0, -0.1) ^ RR(Float64) == ∅
...
@testset "minimal_pow_dec_test" begin
    ...
    @test DecoratedInterval(Interval(0.0, 1.0), def) ^ DecoratedInterval(RR(Float64), def) == DecoratedInterval(Interval(0.0, Inf), trv)
    @test decoration(DecoratedInterval(Interval(0.0, 1.0), def) ^ DecoratedInterval(RR(Float64), def)) == decoration(DecoratedInterval(Interval(0.0, Inf), trv))
    ...
    @test DecoratedInterval(Interval(-0.0, 1.0), com) ^ DecoratedInterval(RR(Float64), def) == DecoratedInterval(Interval(0.0, Inf), trv)
    @test decoration(DecoratedInterval(Interval(-0.0, 1.0), com) ^ DecoratedInterval(RR(Float64), def)) == decoration(DecoratedInterval(Interval(0.0, Inf), trv))
...
@testset "minimal_exp10_test" begin
    ...
    @test exp10(Interval(-0.0, Inf)) == Interval(1.0, Inf)
    @test exp10(RR(Float64)) == Interval(0.0, Inf)
...
@testset "minimal_log_test" begin
    ...
    @test log(Interval(-0.0, Inf)) == RR(Float64)
    @test log(RR(Float64)) == RR(Float64)
...
@testset "minimal_log2_test" begin
    ...
    @test log2(Interval(-0.0, Inf)) == RR(Float64)
    @test log2(RR(Float64)) == RR(Float64)
...
@testset "minimal_log10_test" begin
    ...
    @test log10(Interval(-0.0, Inf)) == RR(Float64)
    @test log10(RR(Float64)) == RR(Float64)
...
@testset "minimal_sin_dec_test" begin
    ...
    @test sin(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-1.0, 1.0), def)
    @test decoration(sin(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-1.0, 1.0), def))
end
...
@testset "minimal_cos_dec_test" begin
    ...
    @test cos(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-1.0, 1.0), def)
    @test decoration(cos(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-1.0, 1.0), def))
end
...
@testset "minimal_tan_test" begin
    ...
    @test tan(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0)) == RR(Float64)
    ...
    @test tan(Interval(-0.0, 0x1.921fb54442d18p+0)) == Interval(0.0, 0x1.d02967c31cdb5p+53)
    @test tan(Interval(0.0, 0x1.921fb54442d19p+0)) == RR(Float64)
    @test tan(Interval(-0.0, 0x1.921fb54442d19p+0)) == RR(Float64)
    @test tan(Interval(0.0, 0x1.921fb54442d18p+1)) == RR(Float64)
    @test tan(Interval(-0.0, 0x1.921fb54442d18p+1)) == RR(Float64)
    @test tan(Interval(0.0, 0x1.921fb54442d19p+1)) == RR(Float64)
    @test tan(Interval(-0.0, 0x1.921fb54442d19p+1)) == RR(Float64)
    @test tan(Interval(0x1p-51, 0x1.921fb54442d18p+1)) == RR(Float64)
    @test tan(Interval(0x1p-51, 0x1.921fb54442d19p+1)) == RR(Float64)
    @test tan(Interval(0x1p-52, 0x1.921fb54442d18p+1)) == RR(Float64)
    @test tan(Interval(0x1p-52, 0x1.921fb54442d19p+1)) == RR(Float64)
    @test tan(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d18p+0)) == Interval(-0x1.d02967c31cdb5p+53, 0x1.d02967c31cdb5p+53)
    @test tan(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0)) == RR(Float64)
    @test tan(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d18p+0)) == RR(Float64)
    @test tan(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)) == RR(Float64)
    ...
    @test tan(Interval(0x1.4e18e147ae148p+12, 0x1.546028f5c28f6p+12)) == RR(Float64)
...
@testset "minimal_tan_dec_test" begin
    ...
    @test tan(DecoratedInterval(Interval(0.0, Inf), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0.0, Inf), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0.0, Inf), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0.0, Inf), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-Inf, 0.0), trv)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-Inf, 0.0), trv))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-Inf, -0.0), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-Inf, -0.0), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    ...
    @test tan(DecoratedInterval(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    ...
    @test tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+0), trv)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+0), trv))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d19p+0), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d19p+0), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d18p+1), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d18p+1), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d18p+1), com)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d18p+1), com))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d19p+1), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0.0, 0x1.921fb54442d19p+1), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0x1p-51, 0x1.921fb54442d18p+1), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1p-51, 0x1.921fb54442d18p+1), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0x1p-51, 0x1.921fb54442d19p+1), com)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1p-51, 0x1.921fb54442d19p+1), com))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0x1p-52, 0x1.921fb54442d18p+1), trv)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1p-52, 0x1.921fb54442d18p+1), trv))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(0x1p-52, 0x1.921fb54442d19p+1), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1p-52, 0x1.921fb54442d19p+1), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    ...
    @test tan(DecoratedInterval(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0x1.921fb54442d18p+0, 0x1.921fb54442d19p+0), trv))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d18p+0), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d18p+0), def))) == decoration(DecoratedInterval(RR(Float64), trv))
    @test tan(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), dac))) == decoration(DecoratedInterval(RR(Float64), trv))
    ...
    @test tan(DecoratedInterval(Interval(0x1.4e18e147ae148p+12, 0x1.546028f5c28f6p+12), def)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(tan(DecoratedInterval(Interval(0x1.4e18e147ae148p+12, 0x1.546028f5c28f6p+12), def))) == decoration(DecoratedInterval(RR(Float64), trv))
...
@testset "minimal_asin_test" begin
    ...
    @test asin(Interval(-Inf, -0.0)) == Interval(-0x1.921fb54442d19p+0, 0.0)
    @test asin(RR(Float64)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
...
@testset "minimal_asin_dec_test" begin
    ...
    @test asin(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(asin(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
...
@testset "minimal_acos_test" begin
    ...
    @test acos(Interval(-Inf, -0.0)) == Interval(0x1.921fb54442d18p+0, 0x1.921fb54442d19p+1)
    @test acos(RR(Float64)) == Interval(0.0, 0x1.921fb54442d19p+1)
...
@testset "minimal_acos_dec_test" begin
    ...
    @test acos(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @test decoration(acos(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv))
...
@testset "minimal_atan_test" begin
    ...
    @test atan(Interval(-Inf, -0.0)) == Interval(-0x1.921fb54442d19p+0, 0.0)
    @test atan(RR(Float64)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
...
@testset "minimal_atan_dec_test" begin
    ...
    @test atan(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def)
    @test decoration(atan(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def))
...
@testset "minimal_atan_test" begin
    ...
    @test atan(RR(Float64), ∅) == ∅
    @test atan(RR(Float64), RR(Float64)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    @test atan(RR(Float64), Interval(0.0, 0.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(0.0, -0.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(-0.0, 0.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(-0.0, -0.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(-2.0, -0.1)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    @test atan(RR(Float64), Interval(-2.0, 0.0)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    @test atan(RR(Float64), Interval(-2.0, -0.0)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    @test atan(RR(Float64), Interval(-2.0, 1.0)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    @test atan(RR(Float64), Interval(0.0, 1.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(-0.0, 1.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(RR(Float64), Interval(0.1, 1.0)) == Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0)
    @test atan(Interval(0.0, 0.0), ∅) == ∅
    @test atan(Interval(0.0, 0.0), RR(Float64)) == Interval(0.0, 0x1.921fb54442d19p+1)
    @test atan(Interval(0.0, 0.0), Interval(0.0, 0.0)) == ∅
    @test atan(Interval(0.0, 0.0), Interval(-0.0, 0.0)) == ∅
    @test atan(Interval(0.0, 0.0), Interval(0.0, -0.0)) == ∅
    @test atan(Interval(0.0, 0.0), Interval(-0.0, -0.0)) == ∅
    ...
    @test atan(Interval(-0.0, -0.0), Interval(0.1, 1.0)) == Interval(0.0, 0.0)
    @test atan(Interval(-2.0, -0.1), ∅) == ∅
    @test atan(Interval(-2.0, -0.1), RR(Float64)) == Interval(-0x1.921fb54442d19p+1, 0.0)
    ...
    @test atan(Interval(-2.0, 0.0), ∅) == ∅
    @test atan(Interval(-2.0, 0.0), RR(Float64)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    ...
    @test atan(Interval(-2.0, -0.0), Interval(0.1, 1.0)) == Interval(-0x1.8555a2787982p+0, 0.0)
    @test atan(Interval(-2.0, 1.0), ∅) == ∅
    @test atan(Interval(-2.0, 1.0), RR(Float64)) == Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1)
    ...
    @test atan(Interval(-0.0, 1.0), ∅) == ∅
    @test atan(Interval(-0.0, 1.0), RR(Float64)) == Interval(0.0, 0x1.921fb54442d19p+1)
    ...
    @test atan(Interval(0.0, 1.0), Interval(0.1, 1.0)) == Interval(0.0, 0x1.789bd2c160054p+0)
    @test atan(Interval(0.1, 1.0), ∅) == ∅
    @test atan(Interval(0.1, 1.0), RR(Float64)) == Interval(0.0, 0x1.921fb54442d19p+1)
...
@testset "minimal_atan_dec_test" begin
    @test atan(DecoratedInterval(∅, trv), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(∅, trv)
    @test decoration(atan(DecoratedInterval(∅, trv), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(∅, trv))
    ...
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(∅, trv))) == decoration(DecoratedInterval(∅, trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, 0.0), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, 0.0), com))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, -0.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, -0.0), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, 0.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, 0.0), dac))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, -0.0), trv)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, -0.0), trv))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, -0.1), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, -0.1), com))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), def))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, 0.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, 0.0), dac))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, -0.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, -0.0), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, 1.0), trv)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-2.0, 1.0), trv))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, 1.0), dac)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.0, 1.0), dac))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, 1.0), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(-0.0, 1.0), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), trv))
    @test atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.1, 1.0), com)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def)
    @test decoration(atan(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(0.1, 1.0), com))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+0, 0x1.921fb54442d19p+0), def))
    ...
    @test atan(DecoratedInterval(Interval(0.0, 0.0), dac), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(0.0, 0.0), dac), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    ...
    @test atan(DecoratedInterval(Interval(-0.0, -0.0), com), DecoratedInterval(∅, trv)) == DecoratedInterval(∅, trv)
    @test decoration(atan(DecoratedInterval(Interval(-0.0, -0.0), com), DecoratedInterval(∅, trv))) == decoration(DecoratedInterval(∅, trv))
    @test atan(DecoratedInterval(Interval(-0.0, -0.0), def), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(-0.0, -0.0), def), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    @test atan(DecoratedInterval(Interval(-0.0, -0.0), dac), DecoratedInterval(Interval(0.0, 0.0), com)) == DecoratedInterval(∅, trv)
    @test decoration(atan(DecoratedInterval(Interval(-0.0, -0.0), dac), DecoratedInterval(Interval(0.0, 0.0), com))) == decoration(DecoratedInterval(∅, trv))
    ...
    @test atan(DecoratedInterval(Interval(-2.0, -0.1), def), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0.0), def)
    @test decoration(atan(DecoratedInterval(Interval(-2.0, -0.1), def), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0.0), def))
    ...
    @test atan(DecoratedInterval(Interval(-2.0, 0.0), def), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(-2.0, 0.0), def), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    ...
    @test atan(DecoratedInterval(Interval(-2.0, -0.0), dac), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(-2.0, -0.0), dac), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    ...
    @test atan(DecoratedInterval(Interval(-2.0, 1.0), dac), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(-2.0, 1.0), dac), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-0x1.921fb54442d19p+1, 0x1.921fb54442d19p+1), trv))
    ...
    @test atan(DecoratedInterval(Interval(-0.0, 1.0), dac), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv)
    @test decoration(atan(DecoratedInterval(Interval(-0.0, 1.0), dac), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), trv))
    ...
    @test atan(DecoratedInterval(Interval(0.1, 1.0), dac), DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), def)
    @test decoration(atan(DecoratedInterval(Interval(0.1, 1.0), dac), DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, 0x1.921fb54442d19p+1), def))
...
@testset "minimal_sinh_dec_test" begin
    @test sinh(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(RR(Float64), def)
    @test decoration(sinh(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(RR(Float64), def))
...
@testset "minimal_cosh_dec_test" begin
    ...
    @test cosh(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(1.0, Inf), def)
    @test decoration(cosh(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(1.0, Inf), def))
...
@testset "minimal_tanh_dec_test" begin
    ...
    @test tanh(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(-1.0, 1.0), def)
    @test decoration(tanh(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(-1.0, 1.0), def))
...
@testset "minimal_asinh_dec_test" begin
    ...
    @test asinh(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(RR(Float64), def)
    @test decoration(asinh(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(RR(Float64), def))
...
@testset "minimal_acosh_test" begin
    ...
    @test acosh(RR(Float64)) == Interval(0.0, Inf)
...
@testset "minimal_acosh_dec_test" begin
    ...
    @test acosh(DecoratedInterval(RR(Float64), def)) == DecoratedInterval(Interval(0.0, Inf), trv)
    @test decoration(acosh(DecoratedInterval(RR(Float64), def))) == decoration(DecoratedInterval(Interval(0.0, Inf), trv))
...
@testset "minimal_atanh_test" begin
    ...
    @test atanh(Interval(1.0, 1.0)) == ∅
    @test atanh(RR(Float64)) == RR(Float64)
...
@testset "minimal_atanh_dec_test" begin
    ...
    @test atanh(DecoratedInterval(Interval(-1.0, 1.0), com)) == DecoratedInterval(RR(Float64), trv)
    @test decoration(atanh(DecoratedInterval(Interval(-1.0, 1.0), com))) == decoration(DecoratedInterval(RR(Float64), trv))
...
@testset "minimal_sign_test" begin
    ...
    @test sign(Interval(-0.0, -0.0)) == Interval(0.0, 0.0)
    @test sign(Interval(-0.0, 0.0)) == Interval(0.0, 0.0)
    @test sign(RR(Float64)) == Interval(-1.0, 1.0)
end
...
@testset "minimal_ceil_test" begin
    @test ceil(∅) == ∅
    @test round(∅, RoundUp) == ∅
    @test ceil(RR(Float64)) == RR(Float64)
    @test round(RR(Float64), RoundUp) == RR(Float64)
...
@testset "minimal_floor_test" begin
    ...
    @test floor(RR(Float64)) == RR(Float64)
    @test round(RR(Float64), RoundDown) == RR(Float64)
...
@testset "minimal_trunc_test" begin
    ...
    @test trunc(RR(Float64)) == RR(Float64)
    @test round(RR(Float64), RoundToZero) == RR(Float64)
...
@testset "minimal_roundTiesToEven_test" begin
    ...
    @test round(RR(Float64)) == RR(Float64)
    @test round(RR(Float64), RoundNearest) == RR(Float64)
    @test round(RR(Float64), RoundTiesToEven) == RR(Float64)
...
@testset "minimal_roundTiesToAway_test" begin
    ...
    @test round(RR(Float64), RoundNearestTiesAway) == RR(Float64)
    @test round(RR(Float64), RoundTiesToAway) == RR(Float64)
...
@testset "minimal_min_test" begin
    ...
    @test min(Interval(1.0, 2.0), ∅) == ∅
    @test min(∅, ∅) == ∅
    @test min(RR(Float64), Interval(1.0, 2.0)) == Interval(-Inf, 2.0)
    @test min(Interval(1.0, 2.0), RR(Float64)) == Interval(-Inf, 2.0)
    @test min(RR(Float64), RR(Float64)) == RR(Float64)
    @test min(∅, RR(Float64)) == ∅
    ...
    @test min(Interval(1.0, 5.0), RR(Float64)) == Interval(-Inf, 5.0)
...
@testset "minimal_min_dec_test" begin
    @test min(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(1.0, 2.0), com)) == DecoratedInterval(Interval(-Inf, 2.0), def)
    @test decoration(min(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(1.0, 2.0), com))) == decoration(DecoratedInterval(Interval(-Inf, 2.0), def))
...
@testset "minimal_max_test" begin
    ...
    @test max(Interval(1.0, 2.0), ∅) == ∅
    @test max(∅, ∅) == ∅
    @test max(RR(Float64), Interval(1.0, 2.0)) == Interval(1.0, Inf)
    @test max(Interval(1.0, 2.0), RR(Float64)) == Interval(1.0, Inf)
    @test max(RR(Float64), RR(Float64)) == RR(Float64)
    @test max(∅, RR(Float64)) == ∅
    @test max(Interval(1.0, 5.0), Interval(2.0, 4.0)) == Interval(2.0, 5.0)
    @test max(Interval(1.0, 5.0), Interval(2.0, 8.0)) == Interval(2.0, 8.0)
    @test max(Interval(-1.0, 5.0), RR(Float64)) == Interval(-1.0, Inf)
...
@testset "minimal_max_dec_test" begin
    @test max(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(1.0, 2.0), com)) == DecoratedInterval(Interval(1.0, Inf), def)
    @test decoration(max(DecoratedInterval(RR(Float64), def), DecoratedInterval(Interval(1.0, 2.0), com))) == decoration(DecoratedInterval(Interval(1.0, Inf), def))
