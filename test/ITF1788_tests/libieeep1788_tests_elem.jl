...
facts("minimal_roundTiesToAway_test") do
    @fact round(∅, RoundNearestTiesAway) round(∅, RoundTiesToAway) --> ∅
    @fact round(entireinterval(Float64), RoundNearestTiesAway) round(entireinterval(Float64), RoundTiesToAway) --> entireinterval(Float64)
    @fact round(Interval(1.1, 2.1), RoundNearestTiesAway) round(Interval(1.1, 2.1), RoundTiesToAway) --> Interval(1.0, 2.0)
    @fact round(Interval(-1.1, 2.0), RoundNearestTiesAway) round(Interval(-1.1, 2.0), RoundTiesToAway) --> Interval(-1.0, 2.0)
    @fact round(Interval(-1.1, 0.0), RoundNearestTiesAway) round(Interval(-1.1, 0.0), RoundTiesToAway) --> Interval(-1.0, 0.0)
    @fact round(Interval(-1.1, -0.0), RoundNearestTiesAway) round(Interval(-1.1, -0.0), RoundTiesToAway) --> Interval(-1.0, -0.0)
    @fact round(Interval(-1.1, -0.4), RoundNearestTiesAway) round(Interval(-1.1, -0.4), RoundTiesToAway) --> Interval(-1.0, 0.0)
    @fact round(Interval(-1.9, 2.2), RoundNearestTiesAway) round(Interval(-1.9, 2.2), RoundTiesToAway) --> Interval(-2.0, 2.0)
    @fact round(Interval(-1.0, 2.2), RoundNearestTiesAway) round(Interval(-1.0, 2.2), RoundTiesToAway) --> Interval(-1.0, 2.0)
    @fact round(Interval(0.5, 2.1), RoundNearestTiesAway) round(Interval(0.5, 2.1), RoundTiesToAway) --> Interval(1.0, 2.0)
    @fact round(Interval(-2.5, 2.0), RoundNearestTiesAway) round(Interval(-2.5, 2.0), RoundTiesToAway) --> Interval(-3.0, 2.0)
    @fact round(Interval(-1.1, -0.5), RoundNearestTiesAway) round(Interval(-1.1, -0.5), RoundTiesToAway) --> Interval(-1.0, -1.0)
    @fact round(Interval(-1.9, 2.5), RoundNearestTiesAway) round(Interval(-1.9, 2.5), RoundTiesToAway) --> Interval(-2.0, 3.0)
    @fact round(Interval(-1.5, 2.5), RoundNearestTiesAway) round(Interval(-1.5, 2.5), RoundTiesToAway) --> Interval(-2.0, 3.0)
    @fact round(Interval(0.0, 2.5), RoundNearestTiesAway) round(Interval(0.0, 2.5), RoundTiesToAway) --> Interval(0.0, 3.0)
    @fact round(Interval(-0.0, 2.5), RoundNearestTiesAway) round(Interval(-0.0, 2.5), RoundTiesToAway) --> Interval(0.0, 3.0)
    @fact round(Interval(-1.5, Inf), RoundNearestTiesAway) round(Interval(-1.5, Inf), RoundTiesToAway) --> Interval(-2.0, Inf)
    @fact round(Interval(-Inf, 2.2), RoundNearestTiesAway) round(Interval(-Inf, 2.2), RoundTiesToAway) --> Interval(-Inf, 2.0)
end
