...
@testset "minimal_add_dec_test" begin
    ...
    @test isnai(+(nai(), interval(bareinterval(1.0,2.0), trv)))
...
@testset "minimal_pow_test" begin
    ...
    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-Inf,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-Inf,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-Inf,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(0.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-0.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(1.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-3.0,5.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(0.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-0.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(-5.0,-5.0)) === emptyinterval(BareInterval{Float64})

    @test ^(emptyinterval(BareInterval{Float64}), bareinterval(5.0,5.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.1,0.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.1,0.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.0,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.0,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.1,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.1,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.1,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(0.1,Inf)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(1.0,1.0)) === bareinterval(0x1.999999999999AP-4,0x1P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(1.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(1.0,Inf)) === bareinterval(0.0,0x1P-1)

    @test ^(bareinterval(0.1,0.5), bareinterval(2.5,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(0.1,0.5), bareinterval(2.5,Inf)) === bareinterval(0.0,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.1,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.1,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.1,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.1,Inf)) === bareinterval(0.0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,Inf)) === bareinterval(0.0,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,Inf)) === bareinterval(0.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,0.1)) === bareinterval(0x1.96B230BCDC434P-1,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,1.0)) === bareinterval(0x1.999999999999AP-4,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,Inf)

    @test ^(bareinterval(0.1,0.5), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,0.0)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,-0.0)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,0.0)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,-0.0)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.125FBEE250664P+0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.125FBEE250664P+0,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.125FBEE250664P+0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1P+1,0x1.4P+3)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1P+1,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(0.1,0.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.6A09E667F3BCCP+2,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,0.5), bareinterval(-Inf,-2.5)) === bareinterval(0x1.6A09E667F3BCCP+2,Inf)

    @test ^(bareinterval(0.1,1.0), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.1,1.0), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.0,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.0,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.1,0.1)) === bareinterval(0x1.96B230BCDC434P-1,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.1,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.1,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(0.1,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(1.0,1.0)) === bareinterval(0x1.999999999999AP-4,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(1.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(1.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(2.5,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(2.5,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,Inf)) === bareinterval(0.0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,Inf)) === bareinterval(0.0,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,0.1)) === bareinterval(0x1.96B230BCDC434P-1,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,1.0)) === bareinterval(0x1.999999999999AP-4,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,Inf)) === bareinterval(0.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,0.1)) === bareinterval(0x1.96B230BCDC434P-1,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,1.0)) === bareinterval(0x1.999999999999AP-4,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,2.5)) === bareinterval(0x1.9E7C6E43390B7P-9,Inf)

    @test ^(bareinterval(0.1,1.0), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,0.0)) === bareinterval(1.0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,-0.0)) === bareinterval(1.0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,0.0)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,-0.0)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,0.0)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,-0.0)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-0.1,-0.1)) === bareinterval(1.0,0x1.4248EF8FC2604P+0)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,-0.1)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,-0.1)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-1.0,-1.0)) === bareinterval(1.0,0x1.4P+3)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,-1.0)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.1,1.0), bareinterval(-2.5,-2.5)) === bareinterval(1.0,0x1.3C3A4EDFA9758P+8)

    @test ^(bareinterval(0.1,1.0), bareinterval(-Inf,-2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.5,1.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.5,1.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.0,1.0)) === bareinterval(0.5,1.5)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.0,1.0)) === bareinterval(0.5,1.5)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.1,0.1)) === bareinterval(0x1.DDB680117AB12P-1,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.1,1.0)) === bareinterval(0.5,1.5)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.1,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(1.0,1.0)) === bareinterval(0.5,1.5)

    @test ^(bareinterval(0.5,1.5), bareinterval(1.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(2.5,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.1,0.1)) === bareinterval(0x1.DDB680117AB12P-1,0x1.125FBEE250665P+0)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.1,1.0)) === bareinterval(0x1P-1,0x1.8P+0)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.1,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.1,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,0.1)) === bareinterval(0x1.5555555555555P-1,0x1P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,1.0)) === bareinterval(0x1P-1,0x1P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), entireinterval(BareInterval{Float64})) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,0.0)) === bareinterval(0x1.5555555555555P-1,0x1P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,-0.0)) === bareinterval(0x1.5555555555555P-1,0x1P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,-0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,0.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,-0.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.125FBEE250665P+0)
    ...
    @test ^(bareinterval(0.5,1.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1.5555555555555P-1,0x1P+1)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,-1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,1.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,1.5), bareinterval(-Inf,-2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(0.5,Inf), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.5,Inf), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.0,1.0)) === bareinterval(0.5,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.0,1.0)) === bareinterval(0.5,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.1,0.1)) === bareinterval(0x1.DDB680117AB12P-1,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.1,1.0)) === bareinterval(0.5,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.1,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(1.0,1.0)) === bareinterval(0.5,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(1.0,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(2.5,2.5)) === bareinterval(0x1.6A09E667F3BCCP-3,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,0.0)) === bareinterval(0.0,0x1P+1)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,-0.0)) === bareinterval(0.0,0x1P+1)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,0.0)) === bareinterval(0.0,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,-0.0)) === bareinterval(0.0,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-0.1,-0.1)) === bareinterval(0.0,0x1.125FBEE250665P+0)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,-0.1)) === bareinterval(0.0,0x1P+1)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,-0.1)) === bareinterval(0.0,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,-0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-1.0,-1.0)) === bareinterval(0.0,0x1P+1)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,-1.0)) === bareinterval(0.0,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,-1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-Inf,-2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.5,Inf), bareinterval(-2.5,-2.5)) === bareinterval(0.0,0x1.6A09E667F3BCDP+2)

    @test ^(bareinterval(1.0,1.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(1.0,1.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.0,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.0,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.0,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.0,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.1,0.1)) === bareinterval(1.0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.1,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.1,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(0.1,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(1.0,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(1.0,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(1.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(2.5,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(2.5,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.1,0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.1,1.0)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.1,2.5)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.1,Inf)) === bareinterval(0x1.EBA7C9E4D31E9P-1,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,0.1)) === bareinterval(0x1.5555555555555P-1,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,1.0)) === bareinterval(0x1.5555555555555P-1,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,2.5)) === bareinterval(0x1.5555555555555P-1,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,Inf)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,Inf)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,0.1)) === bareinterval(0x0P+0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,1.0)) === bareinterval(0x0P+0,0x1.8P+0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,2.5)) === bareinterval(0x0P+0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.0,1.5), entireinterval(BareInterval{Float64})) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,0.0)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,-0.0)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,-0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,-0.1)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,-1.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.0,1.5), bareinterval(-Inf,-2.5)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(1.0,Inf), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.0,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.0,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.0,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.0,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.1,0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.1,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.1,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(0.1,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(1.0,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(1.0,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(1.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(2.5,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(2.5,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.1,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.1,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.1,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.1,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), entireinterval(BareInterval{Float64})) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-0.1,-0.1)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,-0.1)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,-0.1)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,-0.1)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-1.0,-1.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,-1.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,-1.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-2.5,-2.5)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.0,Inf), bareinterval(-Inf,-2.5)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,1.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(1.1,1.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.0,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.0,1.0)) === bareinterval(1.0,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.0,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.0,2.5)) === bareinterval(1.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.1,0.1)) === bareinterval(0x1.02739C65D58BFP+0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.1,1.0)) === bareinterval(0x1.02739C65D58BFP+0,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.1,2.5)) === bareinterval(0x1.02739C65D58BFP+0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(0.1,Inf)) === bareinterval(0x1.02739C65D58BFP+0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(1.0,1.0)) === bareinterval(0x1.199999999999AP+0,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(1.0,2.5)) === bareinterval(0x1.199999999999AP+0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(1.0,Inf)) === bareinterval(0x1.199999999999AP+0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(2.5,2.5)) === bareinterval(0x1.44E1080833B25P+0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(2.5,Inf)) === bareinterval(0x1.44E1080833B25P+0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.1,0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.1,1.0)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.1,2.5)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.1,Inf)) === bareinterval(0x1.EBA7C9E4D31E9P-1,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,0.1)) === bareinterval(0x1.5555555555555P-1,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,1.0)) === bareinterval(0x1.5555555555555P-1,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,2.5)) === bareinterval(0x1.5555555555555P-1,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,Inf)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,Inf)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,0.1)) === bareinterval(0x0P+0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,1.0)) === bareinterval(0x0P+0,0x1.8P+0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,2.5)) === bareinterval(0x0P+0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(1.1,1.5), entireinterval(BareInterval{Float64})) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,0.0)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,-0.0)) === bareinterval(0x1.5555555555555P-1,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,-0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,1.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.5555555555555P-1,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,-0.1)) === bareinterval(0x0P+0,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1.5555555555555P-1,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,-1.0)) === bareinterval(0x0P+0,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,0x1.9372D999784C8P-1)

    @test ^(bareinterval(1.1,1.5), bareinterval(-Inf,-2.5)) === bareinterval(0x0P+0,0x1.9372D999784C8P-1)

    @test ^(bareinterval(1.1,Inf), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(1.1,Inf), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.0,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.0,1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.0,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.0,2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.0,Inf)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.1,0.1)) === bareinterval(0x1.02739C65D58BFP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.1,1.0)) === bareinterval(0x1.02739C65D58BFP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.1,2.5)) === bareinterval(0x1.02739C65D58BFP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(0.1,Inf)) === bareinterval(0x1.02739C65D58BFP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(1.0,1.0)) === bareinterval(0x1.199999999999AP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(1.0,2.5)) === bareinterval(0x1.199999999999AP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(1.0,Inf)) === bareinterval(0x1.199999999999AP+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(2.5,2.5)) === bareinterval(0x1.44E1080833B25P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(2.5,Inf)) === bareinterval(0x1.44E1080833B25P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.1,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.1,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.1,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.1,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,Inf)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,0.1)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,1.0)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,2.5)) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), entireinterval(BareInterval{Float64})) === bareinterval(0x0P+0,Inf)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,-0.0)) === bareinterval(0x0P+0,1.0)

    @test ^(bareinterval(1.1,Inf), bareinterval(-0.1,-0.1)) === bareinterval(0x0P+0,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,-0.1)) === bareinterval(0x0P+0,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,-0.1)) === bareinterval(0x0P+0,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,-0.1)) === bareinterval(0x0P+0,0x1.FB24AF5281928P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-1.0,-1.0)) === bareinterval(0x0P+0,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,-1.0)) === bareinterval(0x0P+0,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,-1.0)) === bareinterval(0x0P+0,0x1.D1745D1745D17P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-2.5,-2.5)) === bareinterval(0x0P+0,0x1.9372D999784C8P-1)

    @test ^(bareinterval(1.1,Inf), bareinterval(-Inf,-2.5)) === bareinterval(0x0P+0,0x1.9372D999784C8P-1)

    @test ^(bareinterval(0.0,0.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.1,0.1)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.1,1.0)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.1,2.5)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.0,0.5), bareinterval(0.1,Inf)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(0.0,0.5), bareinterval(1.0,1.0)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(0.0,0.5), bareinterval(1.0,2.5)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(0.0,0.5), bareinterval(1.0,Inf)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(0.0,0.5), bareinterval(2.5,2.5)) === bareinterval(0.0,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(0.0,0.5), bareinterval(2.5,Inf)) === bareinterval(0.0,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.6A09E667F3BCCP+2,Inf)

    @test ^(bareinterval(0.0,0.5), bareinterval(-Inf,-2.5)) === bareinterval(0x1.6A09E667F3BCCP+2,Inf)

    @test ^(bareinterval(0.0,1.0), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,1.0), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.1,0.1)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.1,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.1,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(0.1,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(1.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(1.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(1.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(2.5,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(2.5,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-0.1,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-1.0,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-2.5,-2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.0), bareinterval(-Inf,-2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(0.0,1.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,1.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.1,0.1)) === bareinterval(0.0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.1,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.1,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.0,1.5), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(1.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(0.0,1.5), bareinterval(1.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.0,1.5), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(2.5,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(0.0,1.5), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,0.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,-0.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,-0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,-0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,-1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(0.0,1.5), bareinterval(-Inf,-2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,Inf), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,Inf), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(0.0,Inf), bareinterval(0.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-0.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(0.0,2.5)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(0.0,Inf), bareinterval(0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(0.0,Inf), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-1.0,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-1.0,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-2.5,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(0.0,Inf), bareinterval(-Inf,0.0)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(-0.1,0.5), bareinterval(0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,0.5), bareinterval(0.0,2.5)) === bareinterval(0.0,1.0)
    ...
    @test ^(bareinterval(-0.1,0.5), bareinterval(0.1,0.1)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(-0.1,0.5), bareinterval(0.1,1.0)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(-0.1,0.5), bareinterval(0.1,2.5)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(-0.1,0.5), bareinterval(0.1,Inf)) === bareinterval(0.0,0x1.DDB680117AB13P-1)

    @test ^(bareinterval(-0.1,0.5), bareinterval(1.0,1.0)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(-0.1,0.5), bareinterval(1.0,2.5)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(-0.1,0.5), bareinterval(1.0,Inf)) === bareinterval(0.0,0.5)

    @test ^(bareinterval(-0.1,0.5), bareinterval(2.5,2.5)) === bareinterval(0.0,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(-0.1,0.5), bareinterval(2.5,Inf)) === bareinterval(0.0,0x1.6A09E667F3BCDP-3)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,0.0)) === bareinterval(1.0,Inf)
    ...
    @test ^(bareinterval(-0.1,0.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-Inf,-0.1)) === bareinterval(0x1.125FBEE250664P+0,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-Inf,-1.0)) === bareinterval(0x1P+1,Inf)

    @test ^(bareinterval(-0.1,0.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.6A09E667F3BCCP+2,Inf)
    ...
    @test ^(bareinterval(-0.1,1.0), bareinterval(0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(0.0,2.5)) === bareinterval(0.0,1.0)
    ...
    @test ^(bareinterval(-0.1,1.0), bareinterval(0.1,0.1)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(0.1,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(0.1,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(0.1,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(1.0,1.0)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(1.0,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(1.0,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(2.5,2.5)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(2.5,Inf)) === bareinterval(0.0,1.0)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,-0.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,0.0)) === bareinterval(1.0,Inf)
    ...
    @test ^(bareinterval(-0.1,1.0), bareinterval(-0.1,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,-0.1)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-1.0,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,-1.0)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-2.5,-2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.0), bareinterval(-Inf,-2.5)) === bareinterval(1.0,Inf)

    @test ^(bareinterval(-0.1,1.5), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.1,0.1)) === bareinterval(0.0,0x1.0A97DCE72A0CBP+0)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.1,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.1,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(-0.1,1.5), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(1.0,1.0)) === bareinterval(0.0,1.5)

    @test ^(bareinterval(-0.1,1.5), bareinterval(1.0,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(-0.1,1.5), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(2.5,2.5)) === bareinterval(0.0,0x1.60B9FD68A4555P+1)

    @test ^(bareinterval(-0.1,1.5), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,0.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,-0.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,-0.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-0.1,-0.1)) === bareinterval(0x1.EBA7C9E4D31E9P-1,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,-0.1)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,-0.1)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,-0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-1.0,-1.0)) === bareinterval(0x1.5555555555555P-1,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,-1.0)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,-1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-2.5,-2.5)) === bareinterval(0x1.7398BF1D1EE6FP-2,Inf)

    @test ^(bareinterval(-0.1,1.5), bareinterval(-Inf,-2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.0,0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-0.0,-0.0)) === bareinterval(1.0,1.0)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-0.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-0.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-0.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.1,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.1,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.1,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(0.1,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(1.0,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(1.0,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(1.0,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(2.5,Inf)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(-0.1,Inf), bareinterval(-1.0,0.1)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,Inf)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-Inf,0.1)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-Inf,1.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-Inf,2.5)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), entireinterval(BareInterval{Float64})) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-1.0,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-1.0,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-2.5,-0.0)) === bareinterval(0.0,Inf)

    @test ^(bareinterval(-0.1,Inf), bareinterval(-Inf,0.0)) === bareinterval(0.0,Inf)
    ...
    @test ^(bareinterval(0.0,0.0), bareinterval(0.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-0.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(0.0,2.5)) === bareinterval(0.0,0.0)
    ...
    @test ^(bareinterval(0.0,0.0), bareinterval(0.1,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(0.1,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(0.1,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(0.1,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(1.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(1.0,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(1.0,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(2.5,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(2.5,Inf)) === bareinterval(0.0,0.0)
    ...
    @test ^(bareinterval(0.0,0.0), bareinterval(-1.0,0.1)) === bareinterval(0.0,0.0)
    ...
    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), entireinterval(BareInterval{Float64})) === bareinterval(0.0,0.0)

    @test ^(bareinterval(0.0,0.0), bareinterval(-1.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-1.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-0.1,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-1.0,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-1.0,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-Inf,-2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(0.0,0.0), bareinterval(-2.5,-2.5)) === emptyinterval(BareInterval{Float64})
    ...
    @test ^(bareinterval(-1.0,0.0), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-0.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-0.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.0,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-0.0,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.0,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-0.0,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.1,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.1,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.1,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(0.1,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(1.0,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(1.0,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(1.0,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(2.5,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(2.5,Inf)) === bareinterval(0.0,0.0)
    ...
    @test ^(bareinterval(-1.0,0.0), bareinterval(-1.0,0.1)) === bareinterval(0.0,0.0)
    ...
    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,Inf)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,0.1)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,1.0)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,2.5)) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), entireinterval(BareInterval{Float64})) === bareinterval(0.0,0.0)

    @test ^(bareinterval(-1.0,0.0), bareinterval(-1.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-1.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-0.1,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-1.0,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,-0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-1.0,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,-1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-Inf,-2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,0.0), bareinterval(-2.5,-2.5)) === emptyinterval(BareInterval{Float64})
    ...
    @test ^(bareinterval(-1.0,-0.1), emptyinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-0.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.0,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-0.0,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.0,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-0.0,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-0.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.1,0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.1,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.1,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(0.1,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(1.0,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(1.0,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(1.0,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(2.5,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(2.5,Inf)) === emptyinterval(BareInterval{Float64})
    ...
    @test ^(bareinterval(-1.0,-0.1), bareinterval(-1.0,0.1)) === emptyinterval(BareInterval{Float64})
    ...
    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,Inf)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-Inf,0.1)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-Inf,1.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-Inf,2.5)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), entireinterval(BareInterval{Float64})) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-1.0,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-1.0,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-2.5,-0.0)) === emptyinterval(BareInterval{Float64})

    @test ^(bareinterval(-1.0,-0.1), bareinterval(-Inf,0.0)) === emptyinterval(BareInterval{Float64})
...
@testset "minimal_pow_dec_test" begin
    ...
    @test ^(interval(bareinterval(0.1,0.5), com), interval(bareinterval(0.0,1.0), com)) === interval(bareinterval(0x1.999999999999AP-4,1.0), com)

    @test ^(interval(bareinterval(0.1,0.5), com), interval(bareinterval(0.1,0.1), def)) === interval(bareinterval(0x1.96B230BCDC434P-1,0x1.DDB680117AB13P-1), def)

    @test ^(interval(bareinterval(0.1,0.5), trv), interval(bareinterval(-2.5,2.5), dac)) === interval(bareinterval(0x1.9E7C6E43390B7P-9,0x1.3C3A4EDFA9758P+8), trv)

    @test ^(interval(bareinterval(0.1,0.5), com), interval(bareinterval(-2.5,Inf), dac)) === interval(bareinterval(0.0,0x1.3C3A4EDFA9758P+8), dac)

    @test ^(interval(bareinterval(0.1,0.5), trv), interval(bareinterval(-Inf,0.1), dac)) === interval(bareinterval(0x1.96B230BCDC434P-1,Inf), trv)

    @test ^(interval(bareinterval(0.1,1.0), com), interval(bareinterval(0.0,2.5), com)) === interval(bareinterval(0x1.9E7C6E43390B7P-9,1.0), com)

    @test ^(interval(bareinterval(0.1,1.0), def), interval(bareinterval(1.0,1.0), dac)) === interval(bareinterval(0x1.999999999999AP-4,1.0), def)

    @test ^(interval(bareinterval(0.1,1.0), trv), interval(bareinterval(-2.5,1.0), def)) === interval(bareinterval(0x1.999999999999AP-4,0x1.3C3A4EDFA9758P+8), trv)

    @test ^(interval(bareinterval(0.5,1.5), dac), interval(bareinterval(0.1,0.1), com)) === interval(bareinterval(0x1.DDB680117AB12P-1,0x1.0A97DCE72A0CBP+0), dac)

    @test ^(interval(bareinterval(0.5,1.5), def), interval(bareinterval(-2.5,0.1), trv)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2), trv)

    @test ^(interval(bareinterval(0.5,1.5), com), interval(bareinterval(-2.5,-2.5), com)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,0x1.6A09E667F3BCDP+2), com)

    @test ^(interval(bareinterval(0.5,Inf), dac), interval(bareinterval(0.1,0.1), com)) === interval(bareinterval(0x1.DDB680117AB12P-1,Inf), dac)

    @test ^(interval(bareinterval(0.5,Inf), def), interval(bareinterval(-2.5,-0.0), com)) === interval(bareinterval(0.0,0x1.6A09E667F3BCDP+2), def)

    @test ^(interval(bareinterval(1.0,1.5), com), interval(bareinterval(-0.1,0.1), def)) === interval(bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.0A97DCE72A0CBP+0), def)

    @test ^(interval(bareinterval(1.0,1.5), trv), interval(bareinterval(-0.1,-0.1), com)) === interval(bareinterval(0x1.EBA7C9E4D31E9P-1,1.0), trv)

    @test ^(interval(bareinterval(1.0,Inf), dac), interval(bareinterval(1.0,1.0), dac)) === interval(bareinterval(1.0,Inf), dac)

    @test ^(interval(bareinterval(1.0,Inf), def), interval(bareinterval(-1.0,-0.0), dac)) === interval(bareinterval(0x0P+0,1.0), def)

    @test ^(interval(bareinterval(1.1,1.5), def), interval(bareinterval(1.0,2.5), com)) === interval(bareinterval(0x1.199999999999AP+0,0x1.60B9FD68A4555P+1), def)

    @test ^(interval(bareinterval(1.1,1.5), com), interval(bareinterval(-0.1,-0.1), com)) === interval(bareinterval(0x1.EBA7C9E4D31E9P-1,0x1.FB24AF5281928P-1), com)

    @test ^(interval(bareinterval(1.1,Inf), dac), interval(bareinterval(0.1,Inf), dac)) === interval(bareinterval(0x1.02739C65D58BFP+0,Inf), dac)

    @test ^(interval(bareinterval(1.1,Inf), def), interval(bareinterval(-2.5,Inf), dac)) === interval(bareinterval(0x0P+0,Inf), def)

    @test ^(interval(bareinterval(1.1,Inf), trv), interval(bareinterval(-Inf,-1.0), def)) === interval(bareinterval(0x0P+0,0x1.D1745D1745D17P-1), trv)

    @test ^(interval(bareinterval(0.0,0.5), com), interval(bareinterval(0.1,0.1), com)) === interval(bareinterval(0.0,0x1.DDB680117AB13P-1), com)

    @test ^(interval(bareinterval(0.0,0.5), com), interval(bareinterval(2.5,Inf), dac)) === interval(bareinterval(0.0,0x1.6A09E667F3BCDP-3), dac)

    @test ^(interval(bareinterval(0.0,0.5), com), interval(bareinterval(-Inf,-2.5), dac)) === interval(bareinterval(0x1.6A09E667F3BCCP+2,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.0), com), interval(bareinterval(0.0,0.0), com)) === interval(bareinterval(1.0,1.0), trv)

    @test ^(interval(bareinterval(0.0,1.0), def), interval(bareinterval(0.0,2.5), dac)) === interval(bareinterval(0.0,1.0), trv)

    @test ^(interval(bareinterval(0.0,1.0), dac), interval(bareinterval(1.0,2.5), com)) === interval(bareinterval(0.0,1.0), dac)

    @test ^(interval(bareinterval(0.0,1.0), com), interval(bareinterval(-2.5,0.1), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.0), def), interval(entireinterval(BareInterval{Float64}), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.0), dac), interval(bareinterval(-0.1,0.0), com)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.0), com), interval(bareinterval(-Inf,0.0), dac)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.0), def), interval(bareinterval(-Inf,-2.5), dac)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.5), com), interval(bareinterval(0.0,2.5), com)) === interval(bareinterval(0.0,0x1.60B9FD68A4555P+1), trv)

    @test ^(interval(bareinterval(0.0,1.5), def), interval(bareinterval(2.5,2.5), dac)) === interval(bareinterval(0.0,0x1.60B9FD68A4555P+1), def)

    @test ^(interval(bareinterval(0.0,1.5), dac), interval(bareinterval(-1.0,0.0), com)) === interval(bareinterval(0x1.5555555555555P-1,Inf), trv)

    @test ^(interval(bareinterval(0.0,1.5), com), interval(bareinterval(-2.5,-2.5), def)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,Inf), trv)

    @test ^(interval(bareinterval(0.0,Inf), dac), interval(bareinterval(0.1,0.1), com)) === interval(bareinterval(0.0,Inf), dac)

    @test ^(interval(bareinterval(0.0,Inf), def), interval(bareinterval(-1.0,1.0), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,Inf), trv), interval(bareinterval(-Inf,-1.0), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,Inf), dac), interval(bareinterval(-2.5,-2.5), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,0.5), com), interval(bareinterval(0.0,Inf), dac)) === interval(bareinterval(0.0,1.0), trv)

    @test ^(interval(bareinterval(-0.0,0.5), def), interval(bareinterval(0.1,Inf), def)) === interval(bareinterval(0.0,0x1.DDB680117AB13P-1), def)

    @test ^(interval(bareinterval(-0.0,0.5), dac), interval(bareinterval(2.5,2.5), com)) === interval(bareinterval(0.0,0x1.6A09E667F3BCDP-3), dac)

    @test ^(interval(bareinterval(-0.0,0.5), trv), interval(bareinterval(-2.5,-0.0), dac)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,0.5), com), interval(bareinterval(-Inf,-0.1), def)) === interval(bareinterval(0x1.125FBEE250664P+0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,0.5), def), interval(bareinterval(-Inf,-2.5), dac)) === interval(bareinterval(0x1.6A09E667F3BCCP+2,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.0), com), interval(bareinterval(2.5,2.5), dac)) === interval(bareinterval(0.0,1.0), dac)

    @test ^(interval(bareinterval(-0.0,1.0), dac), interval(bareinterval(-1.0,Inf), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.0), com), interval(entireinterval(BareInterval{Float64}), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.0), def), interval(bareinterval(-2.5,-2.5), com)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.0), dac), interval(bareinterval(-Inf,-2.5), def)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.5), com), interval(bareinterval(0.1,2.5), dac)) === interval(bareinterval(0.0,0x1.60B9FD68A4555P+1), dac)

    @test ^(interval(bareinterval(-0.0,1.5), def), interval(bareinterval(-1.0,0.0), trv)) === interval(bareinterval(0x1.5555555555555P-1,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.5), dac), interval(bareinterval(-2.5,-0.1), def)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.5), com), interval(bareinterval(-2.5,-2.5), com)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,Inf), trv)

    @test ^(interval(bareinterval(-0.0,1.5), def), interval(bareinterval(-Inf,-2.5), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,Inf), dac), interval(bareinterval(-0.1,Inf), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,Inf), def), interval(bareinterval(-2.5,-0.0), com)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,Inf), trv), interval(bareinterval(-Inf,0.0), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,Inf), dac), interval(bareinterval(-Inf,-0.0), trv)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.0,Inf), def), interval(bareinterval(-Inf,-1.0), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,0.5), def), interval(bareinterval(0.1,Inf), dac)) === interval(bareinterval(0.0,0x1.DDB680117AB13P-1), trv)

    @test ^(interval(bareinterval(-0.1,0.5), com), interval(bareinterval(-0.1,-0.1), com)) === interval(bareinterval(0x1.125FBEE250664P+0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,0.5), dac), interval(bareinterval(-Inf,-2.5), def)) === interval(bareinterval(0x1.6A09E667F3BCCP+2,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.0), com), interval(bareinterval(0.0,0.0), com)) === interval(bareinterval(1.0,1.0), trv)

    @test ^(interval(bareinterval(-0.1,1.0), dac), interval(bareinterval(-Inf,2.5), dac)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.0), def), interval(bareinterval(-Inf,-1.0), def)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.0), com), interval(bareinterval(-2.5,-2.5), com)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.0), trv), interval(bareinterval(-Inf,-2.5), trv)) === interval(bareinterval(1.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.5), trv), interval(bareinterval(0.0,2.5), com)) === interval(bareinterval(0.0,0x1.60B9FD68A4555P+1), trv)

    @test ^(interval(bareinterval(-0.1,1.5), com), interval(bareinterval(2.5,2.5), dac)) === interval(bareinterval(0.0,0x1.60B9FD68A4555P+1), trv)

    @test ^(interval(bareinterval(-0.1,1.5), dac), interval(bareinterval(-1.0,0.0), trv)) === interval(bareinterval(0x1.5555555555555P-1,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.5), com), interval(bareinterval(-0.1,-0.1), com)) === interval(bareinterval(0x1.EBA7C9E4D31E9P-1,Inf), trv)

    @test ^(interval(bareinterval(-0.1,1.5), def), interval(bareinterval(-2.5,-2.5), def)) === interval(bareinterval(0x1.7398BF1D1EE6FP-2,Inf), trv)

    @test ^(interval(bareinterval(-0.1,Inf), dac), interval(bareinterval(-0.1,2.5), com)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,Inf), def), interval(bareinterval(-2.5,0.0), def)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(-0.1,Inf), dac), interval(bareinterval(-2.5,-2.5), trv)) === interval(bareinterval(0.0,Inf), trv)

    @test ^(interval(bareinterval(0.0,0.0), com), interval(bareinterval(1.0,Inf), dac)) === interval(bareinterval(0.0,0.0), dac)

    @test ^(interval(bareinterval(0.0,0.0), com), interval(bareinterval(-2.5,0.1), com)) === interval(bareinterval(0.0,0.0), trv)

    @test ^(interval(bareinterval(0.0,0.0), dac), interval(bareinterval(-1.0,0.0), def)) === interval(emptyinterval(BareInterval{Float64}), trv)

    @test ^(interval(bareinterval(-1.0,-0.1), com), interval(bareinterval(-0.1,1.0), def)) === interval(emptyinterval(BareInterval{Float64}), trv)

    @test ^(interval(bareinterval(-1.0,-0.1), dac), interval(bareinterval(-0.1,2.5), com)) === interval(emptyinterval(BareInterval{Float64}), trv)

    @test ^(interval(bareinterval(-1.0,-0.1), def), interval(bareinterval(-0.1,Inf), trv)) === interval(emptyinterval(BareInterval{Float64}), trv)
