...
@testset "cxsc.intervalstdfunc" begin
    ...
    @test ^(bareinterval(2.0, 2.0), bareinterval(2.0, 2.0)) === bareinterval(4.0, 4.0)

    @test ^(bareinterval(4.0, 4.0), bareinterval(5.0, 5.0)) === bareinterval(1024.0, 1024.0)

    @test ^(bareinterval(2.0, 2.0), bareinterval(3.0, 3.0)) === bareinterval(8.0, 8.0)
