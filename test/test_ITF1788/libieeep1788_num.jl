...
@testset "minimal_mid_rad_test" begin
    ...
    @test isnan(midradius(emptyinterval())[1]) && isnan(midradius(emptyinterval())[2])
...
@testset "minimal_mid_rad_dec_test" begin
    ...
    @test midradius(DecoratedInterval(interval(-Inf,Inf), def))[1] === 0.0 && midradius(DecoratedInterval(interval(-Inf,Inf), def))[2] === Inf

    @test midradius(DecoratedInterval(interval(-0x1.FFFFFFFFFFFFFP+1023,0x1.FFFFFFFFFFFFFP+1023), trv))[1] === 0.0 && midradius(DecoratedInterval(interval(-0x1.FFFFFFFFFFFFFP+1023,0x1.FFFFFFFFFFFFFP+1023), trv))[2] === 0x1.FFFFFFFFFFFFFP+1023

    @test midradius(DecoratedInterval(interval(0.0,2.0), com))[1] === 1.0 && midradius(DecoratedInterval(interval(0.0,2.0), com))[2] === 1.0

    @test midradius(DecoratedInterval(interval(2.0,2.0), dac))[1] === 2.0 && midradius(DecoratedInterval(interval(2.0,2.0), dac))[2] === 0.0

    @test midradius(DecoratedInterval(interval(-2.0,2.0), trv))[1] === 0.0 && midradius(DecoratedInterval(interval(-2.0,2.0), trv))[2] === 2.0

    @test midradius(DecoratedInterval(interval(0.0,Inf), trv))[1] === 0x1.FFFFFFFFFFFFFP+1023 && midradius(DecoratedInterval(interval(0.0,Inf), trv))[2] === Inf

    @test midradius(DecoratedInterval(interval(-Inf, 1.2), trv))[1] === -0x1.FFFFFFFFFFFFFP+1023 && midradius(DecoratedInterval(interval(-Inf, 1.2), trv))[2] === Inf

    @test midradius(DecoratedInterval(interval(-0x0.0000000000002P-1022,0x0.0000000000001P-1022), trv))[1] === 0.0 && midradius(DecoratedInterval(interval(-0x0.0000000000002P-1022,0x0.0000000000001P-1022), trv))[2] === 0x0.0000000000002P-1022

    @test midradius(DecoratedInterval(interval(-0x0.0000000000001P-1022,0x0.0000000000002P-1022), trv))[1] === 0.0 && midradius(DecoratedInterval(interval(-0x0.0000000000001P-1022,0x0.0000000000002P-1022), trv))[2] === 0x0.0000000000002P-1022

    @test midradius(DecoratedInterval(interval(0x1.FFFFFFFFFFFFFP+1022,0x1.FFFFFFFFFFFFFP+1023), trv))[1] === 0x1.7FFFFFFFFFFFFP+1023 && midradius(DecoratedInterval(interval(0x1.FFFFFFFFFFFFFP+1022,0x1.FFFFFFFFFFFFFP+1023), trv))[2] === 0x1.0p+1022

    @test midradius(DecoratedInterval(interval(0x0.0000000000001P-1022,0x0.0000000000003P-1022), trv))[1] === 0x0.0000000000002P-1022 && midradius(DecoratedInterval(interval(0x0.0000000000001P-1022,0x0.0000000000003P-1022), trv))[2] === 0x0.0000000000001P-1022
