...
@testset "mpfi_add" begin
    ...
    @test +(interval(-Inf, 0.0), interval(+8.0, +Inf)) === entireinterval()

    @test +(interval(-Inf, +8.0), interval(0.0, +8.0)) === Interval(-Inf, +16.0)

    @test +(entireinterval(), interval(0.0, +8.0)) === entireinterval()
    ...
    @test +(interval(0.0, 0.0), entireinterval()) === entireinterval()
...
@testset "mpfi_add_d" begin
    ...
    @test +(entireinterval(), interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105)) === entireinterval()

    @test +(entireinterval(), interval(0.0e-17, 0.0e-17)) === entireinterval()
...
@testset "mpfi_atan" begin
    ...
    @test atan(entireinterval()) === Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
...
@testset "mpfi_atan2" begin
    ...
    @test atan(entireinterval(), interval(0.0, +8.0)) === Interval(-0x1921fb54442d19p-52, 0x1921fb54442d19p-52)
    ...
    @test atan(interval(0.0, 0.0), entireinterval()) === Interval(0.0, 0x1921fb54442d19p-51)
...
@testset "mpfi_cbrt" begin
    ...
    @test cbrt(entireinterval()) === entireinterval()
...
@testset "mpfi_cot" begin
    ...
    @test cot(interval(-Inf, -7.0)) === entireinterval()

    @test cot(interval(-Inf, 0.0)) === entireinterval()

    @test cot(interval(-Inf, +8.0)) === entireinterval()

    @test cot(entireinterval()) === entireinterval()

    @test cot(interval(-8.0, 0.0)) === entireinterval()

    @test_skip cot(interval(-3.0, 0.0)) === Interval(-Inf, 0xe07cf2eb32f0bp-49)

    @test cot(interval(-1.0, 0.0)) === Interval(-Inf, -0x148c05d04e1cfdp-53)

    @test cot(interval(0.0, +1.0)) === Interval(0x148c05d04e1cfdp-53, +Inf)

    @test_skip cot(interval(0.0, +3.0)) === Interval(-0xe07cf2eb32f0bp-49, +Inf)

    @test cot(interval(0.0, +8.0)) === entireinterval()

    @test cot(interval(0.0, +Inf)) === entireinterval()

    @test_skip cot(interval(-3.0, -2.0)) === Interval(0x1d4a42e92faa4dp-54, 0xe07cf2eb32f0bp-49)

    @test_skip cot(interval(-3.0, -0x1921fb54442d19p-52)) === Interval(0x5cb3b399d747fp-103, 0xe07cf2eb32f0bp-49)

    @test cot(interval(-2.0, 0x1921fb54442d19p-52)) === entireinterval()

    @test_skip cot(interval(0.125, 0.5)) === Interval(0xea4d6bf23e051p-51, 0x1fd549f047f2bbp-50)

    @test_skip cot(interval(0.125, 0x1921fb54442d19p-52)) === Interval(-0x172cece675d1fdp-105, 0x1fd549f047f2bbp-50)

    @test cot(interval(0x1921fb54442d19p-52, 4.0)) === entireinterval()

    @test_skip cot(interval(4.0, 0x3243f6a8885a3p-47)) === Interval(-0x1d02967c31cdb5p-1, 0x1ba35ba1c6b75dp-53)

    @test_skip cot(interval(0x13a28c59d5433bp-44, 0x9d9462ceaa19dp-43)) === Interval(0x148c05d04e1fb7p-53, 0x1cefdde7c84c27p-4)
...
@testset "mpfi_coth" begin
    ...
    @test coth(interval(-Inf, +8.0)) === entireinterval()

    @test coth(entireinterval()) === entireinterval()
...
@testset "mpfi_csc" begin
    ...
    @test csc(interval(-Inf, -7.0)) === entireinterval()

    @test csc(interval(-Inf, 0.0)) === entireinterval()

    @test csc(interval(-Inf, 8.0)) === entireinterval()

    @test csc(entireinterval()) === entireinterval()

    @test csc(interval(-8.0, 0.0)) === entireinterval()
    ...
    @test csc(interval(0.0, +Inf)) === entireinterval()

    @test csc(interval(-6.0, 7.0)) === entireinterval()

    @test csc(interval(-6.0, 6.0)) === entireinterval()

    @test csc(interval(-6.0, 5.0)) === entireinterval()

    @test csc(interval(-6.0, 4.0)) === entireinterval()

    @test csc(interval(-6.0, 3.0)) === entireinterval()

    @test csc(interval(-6.0, 2.0)) === entireinterval()

    @test csc(interval(-6.0, 1.0)) === entireinterval()

    @test csc(interval(-6.0, 0.0)) === entireinterval()
    ...
    @test csc(interval(-5.0, 6.0)) === entireinterval()

    @test csc(interval(-5.0, 5.0)) === entireinterval()

    @test csc(interval(-5.0, 4.0)) === entireinterval()

    @test csc(interval(-5.0, 3.0)) === entireinterval()

    @test csc(interval(-5.0, 2.0)) === entireinterval()

    @test csc(interval(-5.0, 1.0)) === entireinterval()

    @test csc(interval(-5.0, 0.0)) === entireinterval()
    ...
    @test csc(interval(-4.0, 6.0)) === entireinterval()

    @test csc(interval(-4.0, 5.0)) === entireinterval()

    @test csc(interval(-4.0, 4.0)) === entireinterval()

    @test csc(interval(-4.0, 3.0)) === entireinterval()

    @test csc(interval(-4.0, 2.0)) === entireinterval()

    @test csc(interval(-4.0, 1.0)) === entireinterval()

    @test csc(interval(-4.0, 0.0)) === entireinterval()
    ...
    @test csc(interval(-3.0, 6.0)) === entireinterval()

    @test csc(interval(-3.0, 5.0)) === entireinterval()

    @test csc(interval(-3.0, 4.0)) === entireinterval()

    @test csc(interval(-3.0, 3.0)) === entireinterval()

    @test csc(interval(-3.0, 2.0)) === entireinterval()

    @test csc(interval(-3.0, 1.0)) === entireinterval()
    ...
    @test csc(interval(-2.0, 6.0)) === entireinterval()

    @test csc(interval(-2.0, 5.0)) === entireinterval()

    @test csc(interval(-2.0, 4.0)) === entireinterval()

    @test csc(interval(-2.0, 3.0)) === entireinterval()

    @test csc(interval(-2.0, 2.0)) === entireinterval()

    @test csc(interval(-2.0, 1.0)) === entireinterval()
    ...
    @test csc(interval(-1.0, 6.0)) === entireinterval()

    @test csc(interval(-1.0, 5.0)) === entireinterval()

    @test csc(interval(-1.0, 4.0)) === entireinterval()

    @test csc(interval(-1.0, 3.0)) === entireinterval()

    @test csc(interval(-1.0, 2.0)) === entireinterval()
...
@testset "mpfi_csch" begin
    ...
    @test csch(interval(-Inf, +8.0)) === entireinterval()

    @test csch(entireinterval()) === entireinterval()
...
@testset "mpfi_d_div" begin
    ...
    @test /(interval(-0x16345785d8a00000p0, -0x16345785d8a00000p0), interval(-Inf, 8.0)) === entireinterval()

    @test /(interval(0.0, 0.0), interval(-Inf, 8.0)) === Interval(0.0, 0.0)

    @test /(interval(0x16345785d8a00000p0, 0x16345785d8a00000p0), interval(-Inf, 8.0)) === entireinterval()

    @test /(interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105), entireinterval()) === entireinterval()

    @test /(interval(0.0e-17, 0.0e-17), entireinterval()) === Interval(0.0, 0.0)

    @test /(interval(+0x170ef54646d497p-105, +0x170ef54646d497p-105), entireinterval()) === entireinterval()

    @test /(interval(-0x170ef54646d497p-109, -0x170ef54646d497p-109), interval(0.0, 0.0)) === emptyinterval()
    ...
    @test /(interval(-2.5, -2.5), interval(-8.0, 8.0)) === entireinterval()
...
@testset "mpfi_diam_abs" begin
    ...
    @test_skip diam(interval(-8.0, 0.0)) === +8

    @test_skip diam(interval(0.0, 0.0)) === -0

    @test_skip diam(interval(0.0, 5.0)) === +5

    @test diam(interval(0.0, +Inf)) === +Inf

    @test_skip diam(interval(-34.0, -17.0)) === 17

end

@testset "mpfi_div" begin

    @test /(interval(-Inf, -7.0), interval(-1.0, +8.0)) === entireinterval()

    @test /(interval(-Inf, 0.0), interval(+8.0, +Inf)) === Interval(-Inf, 0.0)

    @test /(interval(-Inf, +8.0), interval(0.0, +8.0)) === entireinterval()
    ...
    @test /(interval(0.0, +8.0), interval(-7.0, +8.0)) === entireinterval()
    ...
    @test /(interval(-0x1.25f2d73472753p+0, -0x9.9a19fd3c1fc18p-4), interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4)) === entireinterval()
    ...
    @test /(interval(-0x1.25f2d73472753p+0, 0.0), interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4)) === entireinterval()
    ...
    @test /(interval(-0xacbp+256, 0x6f9p0), interval(-0x7p0, 0.0)) === entireinterval()

    @test /(interval(-0x1.25f2d73472753p+0, +0x9.9a19fd3c1fc18p-4), interval(-0x9.3b0c8074ccc18p-4, +0x4.788df5d72af78p-4)) === entireinterval()

    @test /(interval(0.0, +15.0), interval(-3.0, +3.0)) === entireinterval()
    ...
    @test /(interval(0.0, 0xap0), interval(-1.0, +1.0)) === entireinterval()
    ...
    @test /(interval(5.0, 6.0), interval(-0x5.0d4d319a50b04p-4, 0x2.d8f51df1e322ep-4)) === entireinterval()
...
@testset "mpfi_div_d" begin
    ...
    @test /(interval(-Inf, -7.0), interval(0.0, 0.0)) === emptyinterval()
    ...
    @test /(interval(-Inf, 8.0), interval(0.0, 0.0)) === emptyinterval()

    @test /(interval(-Inf, 8.0), interval(3.0, 3.0)) === Interval(-Inf, 0x15555555555556p-51)

    @test /(entireinterval(), interval(-0x170ef54646d497p-105, -0x170ef54646d497p-105)) === entireinterval()

    @test /(entireinterval(), interval(0.0e-17, 0.0e-17)) === emptyinterval()
...
@testset "mpfi_d_sub" begin
    ...
    @test -(interval(0.0e-17, 0.0e-17), entireinterval()) === entireinterval()
...
@testset "mpfi_expm1" begin
    ...
    @test expm1(entireinterval()) === Interval(-1.0, +Inf)
...
@testset "mpfi_hypot" begin
    ...
    @test hypot(entireinterval(), interval(0.0, 8.0)) === Interval(0.0, +Inf)
...
@testset "mpfi_intersect" begin
    ...
    @test intersect(interval(-Inf, -7.0), interval(-1.0, +8.0)) === emptyinterval()

    @test intersect(interval(-Inf, 0.0), interval(+8.0, +Inf)) === emptyinterval()

    @test intersect(interval(-Inf, +8.0), interval(0.0, +8.0)) === Interval(0.0, +8.0)

    @test intersect(entireinterval(), interval(0.0, +8.0)) === Interval(0.0, +8.0)

    @test intersect(interval(0.0, 0.0), interval(-Inf, -7.0)) === emptyinterval()
    ...
    @test intersect(interval(0.0, 0.0), interval(+8.0, +Inf)) === emptyinterval()

    @test intersect(interval(0.0, 0.0), entireinterval()) === Interval(0.0, 0.0)
...
@testset "mpfi_inv" begin
    ...
    @test inv(interval(-Inf, +4.0)) === entireinterval()
...
@testset "mpfi_is_nonneg" begin
    ...
    @test ≤(interval(0.0, 0.0), entireinterval()) === false

    @test ≤(interval(0.0, 0.0), interval(-8.0, 0.0)) === false

    @test ≤(interval(0.0, 0.0), interval(0.0, 0.0)) === true

    @test ≤(interval(0.0, 0.0), interval(0.0, 5.0)) === true

    @test ≤(interval(0.0, 0.0), interval(0.0, +Inf)) === true

    @test ≤(interval(0.0, 0.0), interval(5.0, +Inf)) === true
    ...
    @test ≤(interval(0.0, 0.0), interval(0x1921fb54442d18p-51, 0x1921fb54442d19p-51)) === true

    @test ≤(interval(0.0, 0.0), interval(+8.0, +0x7fffffffffffbp+51)) === true

    @test ≤(interval(0.0, 0.0), interval(+0x1fffffffffffffp-53, 2.0)) === true

end

@testset "mpfi_is_nonpos" begin

    @test ≤(interval(-Inf, -8.0), interval(0.0, 0.0)) === true

    @test ≤(interval(-Inf, 0.0), interval(0.0, 0.0)) === true

    @test ≤(interval(-Inf, 5.0), interval(0.0, 0.0)) === false

    @test ≤(entireinterval(), interval(0.0, 0.0)) === false

    @test ≤(interval(-8.0, 0.0), interval(0.0, 0.0)) === true
    ...
    @test ≤(interval(-34.0, -17.0), interval(0.0, 0.0)) === true

    @test ≤(interval(-8.0, -1.0), interval(0.0, 0.0)) === true
...
@testset "mpfi_mag" begin
    ...
    @test_skip mag(interval(-8.0, 0.0)) === +8

    @test_skip mag(interval(0.0, 0.0)) === +0

    @test_skip mag(interval(0.0, 5.0)) === +5

    @test mag(interval(0.0, +Inf)) === +Inf

    @test_skip mag(interval(-34.0, -17.0)) === 34

end

@testset "mpfi_mid" begin

    @test_skip mid(interval(-8.0, 0.0)) === -4

    @test_skip mid(interval(0.0, 0.0)) === +0
...
@testset "mpfi_mig" begin
    ...
    @test_skip mig(interval(-Inf, -8.0)) === 8

    @test_skip mig(interval(-Inf, 0.0)) === +0

    @test_skip mig(interval(-Inf, 5.0)) === +0

    @test_skip mig(entireinterval()) === +0

    @test_skip mig(interval(-Inf, 0.0)) === +0

    @test_skip mig(interval(-8.0, 0.0)) === +0

    @test_skip mig(interval(0.0, 0.0)) === +0

    @test_skip mig(interval(0.0, 5.0)) === +0

    @test_skip mig(interval(0.0, +Inf)) === +0

    @test_skip mig(interval(-34.0, -17.0)) === 17
...
@testset "mpfi_mul_d" begin
    ...
    @test *(entireinterval(), interval(0.0e-17, 0.0e-17)) === Interval(0.0, 0.0)
...
@testset "mpfi_sec" begin
    ...
    @test sec(interval(-Inf, -7.0)) === entireinterval()

    @test sec(interval(-Inf, 0.0)) === entireinterval()

    @test sec(interval(-Inf, 8.0)) === entireinterval()

    @test sec(entireinterval()) === entireinterval()

    @test sec(interval(-8.0, 0.0)) === entireinterval()
    ...
    @test sec(interval(0.0, 8.0)) === entireinterval()

    @test sec(interval(0.0, +Inf)) === entireinterval()

    @test sec(interval(-6.0, 7.0)) === entireinterval()

    @test sec(interval(-6.0, 6.0)) === entireinterval()

    @test sec(interval(-6.0, 5.0)) === entireinterval()

    @test sec(interval(-6.0, 4.0)) === entireinterval()

    @test sec(interval(-6.0, 3.0)) === entireinterval()

    @test sec(interval(-6.0, 2.0)) === entireinterval()

    @test sec(interval(-6.0, 1.0)) === entireinterval()

    @test sec(interval(-6.0, 0.0)) === entireinterval()
    ...
    @test sec(interval(-5.0, 6.0)) === entireinterval()

    @test sec(interval(-5.0, 5.0)) === entireinterval()

    @test sec(interval(-5.0, 4.0)) === entireinterval()

    @test sec(interval(-5.0, 3.0)) === entireinterval()

    @test sec(interval(-5.0, 2.0)) === entireinterval()

    @test sec(interval(-5.0, 1.0)) === entireinterval()

    @test sec(interval(-5.0, 0.0)) === entireinterval()
    ...
    @test sec(interval(-4.0, 6.0)) === entireinterval()

    @test sec(interval(-4.0, 5.0)) === entireinterval()

    @test sec(interval(-4.0, 4.0)) === entireinterval()

    @test sec(interval(-4.0, 3.0)) === entireinterval()

    @test sec(interval(-4.0, 2.0)) === entireinterval()

    @test sec(interval(-4.0, 1.0)) === entireinterval()

    @test sec(interval(-4.0, 0.0)) === entireinterval()
    ...
    @test sec(interval(-3.0, 6.0)) === entireinterval()

    @test sec(interval(-3.0, 5.0)) === entireinterval()

    @test sec(interval(-3.0, 4.0)) === entireinterval()

    @test sec(interval(-3.0, 3.0)) === entireinterval()

    @test sec(interval(-3.0, 2.0)) === entireinterval()
    ...
    @test sec(interval(-2.0, 6.0)) === entireinterval()

    @test sec(interval(-2.0, 5.0)) === entireinterval()

    @test sec(interval(-2.0, 4.0)) === entireinterval()

    @test sec(interval(-2.0, 3.0)) === entireinterval()

    @test sec(interval(-2.0, 2.0)) === entireinterval()

    @test sec(interval(-2.0, 1.0)) === entireinterval()

    @test sec(interval(-2.0, 0.0)) === entireinterval()
    ...
    @test sec(interval(-1.0, 6.0)) === entireinterval()

    @test sec(interval(-1.0, 5.0)) === entireinterval()

    @test sec(interval(-1.0, 4.0)) === entireinterval()

    @test sec(interval(-1.0, 3.0)) === entireinterval()
...
@testset "mpfi_tan" begin
    ...
    @test tan(interval(-Inf, -7.0)) === entireinterval()

    @test tan(interval(-Inf, 0.0)) === entireinterval()

    @test tan(interval(-Inf, +8.0)) === entireinterval()
    ...
    @test tan(interval(0.0, +8.0)) === entireinterval()

    @test tan(interval(0.0, +Inf)) === entireinterval()

    @test tan(interval(0.125, 17.0)) === entireinterval()
    ...
    @test tan(interval(-7.0, 7.0)) === entireinterval()

    @test tan(interval(-7.0, 6.0)) === entireinterval()

    @test tan(interval(-7.0, 5.0)) === entireinterval()

    @test tan(interval(-7.0, 4.0)) === entireinterval()

    @test tan(interval(-7.0, 3.0)) === entireinterval()

    @test tan(interval(-7.0, 2.0)) === entireinterval()

    @test tan(interval(-7.0, 1.0)) === entireinterval()

    @test tan(interval(-7.0, 0.0)) === entireinterval()
    ...
    @test tan(interval(-6.0, 7.0)) === entireinterval()

    @test tan(interval(-6.0, 6.0)) === entireinterval()

    @test tan(interval(-6.0, 5.0)) === entireinterval()

    @test tan(interval(-6.0, 4.0)) === entireinterval()

    @test tan(interval(-6.0, 3.0)) === entireinterval()

    @test tan(interval(-6.0, 2.0)) === entireinterval()

    @test tan(interval(-6.0, 1.0)) === entireinterval()

    @test tan(interval(-6.0, 0.0)) === entireinterval()
    ...
    @test tan(interval(-5.0, 7.0)) === entireinterval()

    @test tan(interval(-5.0, 6.0)) === entireinterval()

    @test tan(interval(-5.0, 5.0)) === entireinterval()

    @test tan(interval(-5.0, 4.0)) === entireinterval()

    @test tan(interval(-5.0, 3.0)) === entireinterval()

    @test tan(interval(-5.0, 2.0)) === entireinterval()

    @test tan(interval(-5.0, 1.0)) === entireinterval()

    @test tan(interval(-5.0, 0.0)) === entireinterval()
    ...
    @test tan(interval(-4.0, 7.0)) === entireinterval()

    @test tan(interval(-4.0, 6.0)) === entireinterval()

    @test tan(interval(-4.0, 5.0)) === entireinterval()

    @test tan(interval(-4.0, 4.0)) === entireinterval()

    @test tan(interval(-4.0, 3.0)) === entireinterval()

    @test tan(interval(-4.0, 2.0)) === entireinterval()

    @test tan(interval(-4.0, 1.0)) === entireinterval()

    @test tan(interval(-4.0, 0.0)) === entireinterval()
    ...
    @test tan(interval(-3.0, 7.0)) === entireinterval()

    @test tan(interval(-3.0, 6.0)) === entireinterval()

    @test tan(interval(-3.0, 5.0)) === entireinterval()

    @test tan(interval(-3.0, 4.0)) === entireinterval()

    @test tan(interval(-3.0, 3.0)) === entireinterval()

    @test tan(interval(-3.0, 2.0)) === entireinterval()

    @test tan(interval(-3.0, 1.0)) === entireinterval()

    @test tan(interval(-3.0, 0.0)) === entireinterval()
    ...
    @test tan(interval(-2.0, 7.0)) === entireinterval()

    @test tan(interval(-2.0, 6.0)) === entireinterval()

    @test tan(interval(-2.0, 5.0)) === entireinterval()

    @test tan(interval(-2.0, 4.0)) === entireinterval()

    @test tan(interval(-2.0, 3.0)) === entireinterval()

    @test tan(interval(-2.0, 2.0)) === entireinterval()

    @test tan(interval(-2.0, 1.0)) === entireinterval()

    @test tan(interval(-2.0, 0.0)) === entireinterval()

    @test tan(interval(-2.0, -1.0)) === entireinterval()

    @test tan(interval(-2.0, -2.0)) === Interval(0x117af62e0950f8p-51, 0x117af62e0950f9p-51)

    @test tan(interval(-1.0, 7.0)) === entireinterval()

    @test tan(interval(-1.0, 6.0)) === entireinterval()

    @test tan(interval(-1.0, 5.0)) === entireinterval()

    @test tan(interval(-1.0, 4.0)) === entireinterval()

    @test tan(interval(-1.0, 3.0)) === entireinterval()

    @test tan(interval(-1.0, 2.0)) === entireinterval()
...
@testset "mpfi_union" begin
    ...
    @test hull(interval(-Inf, 0.0), interval(+8.0, +Inf)) === entireinterval()

    @test hull(interval(-Inf, +8.0), interval(0.0, +8.0)) === Interval(-Inf, +8.0)

    @test hull(entireinterval(), interval(0.0, +8.0)) === entireinterval()
    ...
    @test hull(interval(0.0, 0.0), entireinterval()) === entireinterval()
