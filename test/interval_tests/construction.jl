...
@testset "Conversions and promotions" begin
    ...
    @test isequal_interval(convert(Interval{Float64}, 1), interval(1, IntervalArithmetic.bad))
    @test isequal_interval(convert(Complex{Interval{Float64}}, 1), interval(1+0im, IntervalArithmetic.bad))
    @test isequal_interval(convert(Complex{Interval{Float64}}, im), interval(im, IntervalArithmetic.bad))
    @test isequal_interval(convert(Interval{Float64}, 1+0im), convert(Interval{Float64}, interval(1+0im)), interval(1, IntervalArithmetic.bad))
