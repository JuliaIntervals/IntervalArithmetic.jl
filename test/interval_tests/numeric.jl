...
@testset "Power tests" begin
    ...
    @test isequal_interval(nthpow(interval(-3,0) , 2), interval(0, 9))
    @test isequal_interval(nthpow(interval(-3,-2), 2), interval(4, 9))
    @test isequal_interval(nthpow(interval(-3,2) , 2), interval(0, 9))
    @test isequal_interval(nthpow(interval(0,3)  , 3), interval(0, 27))
    @test isequal_interval(nthpow(interval(2,3)  , 3), interval(8, 27))
    @test isequal_interval(nthpow(interval(-3,0) , 3), interval(-27., 0.))
    @test isequal_interval(nthpow(interval(-3,-2), 3), interval(-27, -8))
    @test isequal_interval(nthpow(interval(-3,2) , 3), interval(-27., 8.))
    @test isequal_interval(nthpow(interval(0,3)  , -2), interval(1/9, Inf))
    @test isequal_interval(nthpow(interval(-3,0) , -2), interval(1/9, Inf))
    @test isequal_interval(nthpow(interval(-3,2) , -2), interval(1/9, Inf))
    @test isequal_interval(nthpow(interval(2,3)  , -2), interval(1/9, 1/4))
    @test isequal_interval(nthpow(interval(1,2)  , -3), interval(1/8, 1.0))
    @test isequal_interval(nthpow(interval(0,3)  , -3), interval(1/27, Inf))
    @test isequal_interval(nthpow(interval(-1,2) , -3), entireinterval())
    @test isequal_interval(nthpow(interval(-3,2) ,  3), interval(-27, 8))
    @test isequal_interval(interval(0.0) ^ interval(1.1), interval(0))
    @test isequal_interval(nthpow(interval(0.0)  , 0), interval(1))
    ...
    @test isequal_interval(nthpow(emptyinterval(), 0), emptyinterval())
    @test isequal_interval(nthpow(interval(2.5) , 3), interval(15.625, 15.625))
    @test isequal_interval(nthpow(interval(5//2), 3), interval(125//8))

    x = interval(-3, 2)
    @test isequal_interval(nthpow(x, 3), interval(-27, 8))
    ...
    @test isequal_interval(nthpow(interval(-3, 2), 2), interval(0.0, 9.0))
    @test isequal_interval(interval(-3, 4) ^ interval(0.5), interval(0, 2))
...
@testset "Fast power" begin
    ...
    @testset "Fast integer powers" begin
        ...
        @test isstrictsubset_interval(x^50, fastpow(x, 50))
