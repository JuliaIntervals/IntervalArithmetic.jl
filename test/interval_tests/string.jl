...
@testset "IntervalToText" begin
    ...
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 1 .  ]") == "[2, 4]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 2 .  ]") == "[ 2,  4]"
    ...
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 8 .  ]") == "[ 2.35345,  3.56453]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 9 .  ]") == "[  2.35345,   3.56453]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 10 .  ]") == "[   2.35345,    3.56453]"
    ...
    @test string(Interval(2.3534534644, 3.564537887687), "12 : [  4 . 1]") == "[ 2.3,  3.6]"
    @test string(Interval(23.534534644, 100.64537887687), "10 : [c .  e]") == "[2e1, 2e2]"
    @test string(Interval(23.534534644, 100.64537887687), "11 : [c .  e]") == " [2e1, 2e2]"
    @test string(Interval(23.534534644, 100.64537887687), "12 : [c .  e]") == "[2.3e1, 2e2]"
    @test string(Interval(23.534534644, 100.64537887687), "13 : [c .  e]") == "[2.35e1, 2e2]"
    @test string(Interval(23.534534644, 100.64537887687), "14 : [c .  e]") == "[2.3e1, 1.1e2]"
    @test string(Interval(23.534534644, 100.64537887687), "15 : [c .  e]") == "[2.35e1, 1.1e2]"
    @test string(Interval(23.534534644, 100.64537887687), "16 : [c .  e]") == "[2.35e1, 1.01e2]"
    @test string(Interval(23.534534644, 100.64537887687), "17 : [c .  e]") == "[2.353e1, 1.01e2]"
    @test string(Interval(23.534534644, 100.64537887687), "18 : [c .  e]") == "[2.353e1, 1.007e2]"
    @test string(Interval(23.534534644, 100.64537887687), "19 : [c .  e]") == "[2.3534e1, 1.007e2]"
    @test string(Interval(23.534534644, 100.64537887687), "20 : [c .  e]") == "[2.3534e1, 1.0065e2]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 3 .  e]") == "[2e0, 4e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 4 .  e]") == "[ 2e0,  4e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 5 .  e]") == "[2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 6 .  e]") == "[2.35e0, 3.57e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 7 .  e]") == "[2.353e0, 3.565e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 8 .  e]") == "[2.3534e0, 3.5646e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 9 .  e]") == "[2.35345e0, 3.56454e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 10 .  e]") == "[ 2.35345e0,  3.56453e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 11 .  e]") == "[  2.35345e0,   3.56453e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 12 .  e]") == "[   2.35345e0,    3.56453e0]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 0 e]") == "[2e0, 4e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 1 e]") == "[2.3e0, 3.1e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 2 e]") == "[2.35e0, 3.06e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 3 e]") == "[2.353e0, 3.057e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 4 e]") == "[2.3534e0, 3.0565e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 5 e]") == "[2.35345e0, 3.05646e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 6 e]") == "[2.353453e0, 3.056454e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 7 e]") == "[2.3534534e0, 3.0564538e1]"
    @test string(Interval(2.3534534644, 30.564537887687), " : [c  . 8 e]") == "[2.35345346e0, 3.05645379e1]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 3 . 0 e]") == "[2e0, 4e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 5 . 1 e]") == "[2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 6 . 1 e]") == "[ 2.3e0,  3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 6 . 2 e]") == "[2.35e0, 3.57e0]"
    @test string(Interval(2.3534534644, 3.564537887687), " : [c 7 . 2 e]") == "[ 2.35e0,  3.57e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c  . 2 e]") == "[2.35e0, 3.57e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c  . 1 e]") == "  [2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c  . 0 e]") == "      [2e0, 4e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "18 : [c  . 3 e]") == "[2.353e0, 3.565e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "19 : [c  . 3 e]") == " [2.353e0, 3.565e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "20 : [c  . 4 e]") == "[2.3534e0, 3.5646e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c 5 .  e]") == "  [2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c 5 . 1 e]") == "  [2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c 5 . 1 e]") == "  [2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "14 : [c 5 . 1 e]") == "[2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [c 6 . 1 e]") == "[ 2.3e0,  3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [  5 . 1 e]") ==  "  [2.3e0, 3.6e0]"
    @test string(Interval(2.3534534644, 3.564537887687), "16 : [  6 . 1 e]") == "[ 2.3e0,  3.6e0]"
    ...
    @test string(35.5 .. 36.78, "8 :  4 . 2 ? 1 e") == "3.61?7e1"
    @test string(35.5 .. 36.78, "9 :  4 . 2 ? 1 e") == " 3.61?7e1"
    @test string(35.55 .. 35.65, "9 : . 3 ? 1 e") == "3.560?6e1"
    @test string(35.55 .. 35.65, "10 : . 3 ? 1 e") == " 3.560?6e1"
    @test string(35.55 .. 35.65, "10 :c 6 . 3 ? 1 e") == " 3.560?6e1"
    @test string(35.55 .. 35.65, "10 :0 6 . 3 ? 1 e") == "03.560?6e1"
    ...
    @test string(35.5 .. 35.78, "8 :  4 .  ? e") == "3.56?2e1"
    @test string(35.5 .. 35.78, "9 :  4 .  ? e") == " 3.56?2e1"
    @test string(Interval(35.55, 35.65), "9 : .  ? e") == "3.560?6e1"
    @test string(Interval(35.55, 35.65), "10 : .  ? e") == " 3.560?6e1"
    @test string(Interval(35.55, 35.65), "10 :c 6 .  ? e") == " 3.560?6e1"
    @test string(Interval(35.55, 35.65), "10 :0 6 . ? e") == "03.560?6e1"
end
